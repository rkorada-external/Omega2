#!/bin/ksh
export DELIVERY_PATH="/scor/scoromega/delivery/4A_DELIVERY/OM2.DELIVERY"
export LELT_FILENAME="OM2.4A_DELIVERY_AZDEV.csv"
export RIGHT_FILENAME="OM2.4A_DELIVERY_AZITK.csv"
