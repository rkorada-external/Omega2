#!/bin/ksh
export DELIVERY_PATH="/scor/scoromega/delivery/3K_DELIVERY/OM2.DELIVERY"
export LELT_FILENAME="OM2.3K_DELIVERY_AZDEV.csv"
export RIGHT_FILENAME="OM2.3K_DELIVERY_AZITK.csv"
