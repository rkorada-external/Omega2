...
alias gocmd="cd $DCMD"
alias gocmdp='cd    /scoromega_runnable_aenprdo2batch/cmd;'
alias gocmdu='cd    /scoromega_runnable_aenuato2batch/cmd'
alias gocmdi='cd    /scoromega_runnable_aeninto2batch/cmd'
alias gocmd2='cd    /scoromega_runnable_aenin2o2batch/cmd'
alias gocmdm='cd    /scoromega_runnable_aenmaio2batch/cmd'
alias gocmdc='cd    /scoromega_runnable_aencnvo2batch/cmd;'
alias gocmdk='cd    /scoromega_runnable_aenitko2batch/cmd'
