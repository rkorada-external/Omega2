...
[02]  21/07/2015  SAS  spot:29113 r�cup�ration de TRNCOD a 8 plutot que 7
...
[06]  12/10/2016 Florent :spot:31344 Correction format mois/jour(1/1) et plus de strcpy dans l'ENR en entr�e !
[07]  27/04/2017 Roger   :spira:60426 Adaptation du programme pour traiter un fichier format FTECLEDA
[08]  04/02/2021 Roger   :spira:91379 gestion des ouvertures pour postes IFRS17 et maj commentaire
[09]  28/01/2022 Roger  :spira:98240 Ajout TRN_NT, RETARDRETINT_B, GAAPCOD_NT, I17PRDCOD_CT dans la cl� de rupture et code Ouverture 'O' dans col GT_NEWCOLS5_NF
[10]  10/01/2023 DAD  :spira:108412 les TRNCOD qui commencent par 3 et 4 sont exclu des ouverture
======================================================================================*/
...
char Ksz_TypFic[6] ;        /* parametre de la chaine: type de fichier GLTAR/GLTRR */
//[09]
...
)
{
  ...
  /* Recuperation Type de fichier GT ou GLT [07] */
  strcpy(Ksz_TypFic, psz_GetCharArgv(3)) ;
  ...
  if (n_OpenFileAppl("ESTM7602b_O1", "wt", &Kp_OutputFile) == ERR) {
  ...
  if (n_CloseFileAppl("ESTM7602b_I1", &(pbd_Rupture->pf_InputFil)) == ERR) {
    ExitPgm(ERR_XX, "Erreur appel fonction n_CloseFileAppl");
  }

  if (n_CloseFileAppl("ESTM7602b_O1", &Kp_OutputFile) == ERR) {
    ExitPgm(ERR_XX , "Erreur appel fonction n_CloseFileAppl");
  }
...
)
{
  ...
  if (n_OpenFileAppl("ESTM7602b_I1", "rt", &(pbd_Rupture->pf_InputFil)) == ERR) {
    RETURN_VAL(ERR);
  }
...
//  Si le poste correspond : initialisation des cumuls
  ...
  // ** ne pas prendre en compte les lignes de la filiale CRP (13 ) qui v�rifie les conditions ci-dessous
  // ************************************************************************
  if
  (
    (
      ...
      (
        (
          (ptsz_LigneCour[GT_TRNCOD_CF][0] == '1') ||
          (ptsz_LigneCour[GT_TRNCOD_CF][0] == '2') ||
          (ptsz_LigneCour[GT_TRNCOD_CF][0] == '3') ||     // [10]
          (ptsz_LigneCour[GT_TRNCOD_CF][0] == '4')        // [10]
        ) &&
        (
...
// dans le fichier de reconduction
  ...
  if (Ks_Analyse) {
    ...
    ptsz_LigneCour[Ks_GT_NEWCOLS5_NF] = "O";  // [09]
    ...
    if   ( (ptsz_LigneCour[GT_TRNCOD_CF][1] >= '1') && (ptsz_LigneCour[GT_TRNCOD_CF][1] <= '3')  )
    {
      ...
      case 'G':
        ...
        break;
      case 'I':
        sz_TRNCOD_CF[7] = 'J';   // [08] for I17G
        break;
      case 'K':
        sz_TRNCOD_CF[7] = 'L';   // [08] for I17P
        break;
      case 'M':
        sz_TRNCOD_CF[7] = 'N';   // [08] for I17L
        break;
      case '2':
        sz_TRNCOD_CF[7] = '3';
        break;
    ...
    // [08] for I17
/*    if   ( (ptsz_LigneCour[GT_TRNCOD_CF][0] == '1' || ptsz_LigneCour[GT_TRNCOD_CF][0] == '2')  && 
    	     (ptsz_LigneCour[GT_TRNCOD_CF][7] == 'I' || ptsz_LigneCour[GT_TRNCOD_CF][7] == 'J' || ptsz_LigneCour[GT_TRNCOD_CF][7] == 'K')
    	   )
    {
      sprintf(sz_TRNCOD_CF, "%d", atoi(ptsz_LigneCour[GT_TRNCOD_CF]) );
      switch (ptsz_LigneCour[GT_TRNCOD_CF][7])    //[001]
