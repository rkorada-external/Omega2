...
FILE 		   *Kp_OutputFileSTATGTA;
FILE 		   *Kp_OutputFileARCSTATGTA;
FILE 		   *Kp_OutputFileGTAR;
FILE 		   *Kpf_InputFilIRD;
...
/* Ouverture du fichier de sortie dommages */
   if (n_OpenFileAppl("ESTM7615_O1", "wt", &Kp_OutputFileDom) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_OpenFileApplDom");
   }

/* Ouverture du fichier de sortie vie */
   if (n_OpenFileAppl("ESTM7615_O2", "wt", &Kp_OutputFileVie) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_OpenFileApplVie");
   }

/* Ouverture du fichier d'anomalies */
   if (n_OpenFileAppl("ESTM7615_O3", "wt", &Kp_OutputFileAno) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_OpenFileApplAno");
   }

/* Ouverture du fichier d'anomalies */
   if (n_OpenFileAppl("ESTM7615_O4", "wt", &Kp_OutputFileGTAR) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_OpenFileApplGTAR");
   }
...
/* Initialisation de la structure de synchronisation du GTAavec le perimetre */
   if (n_InitSync(&bd_SyncGTA, "ESTM7615_I2") == ERR) {
...
/* Initialisation de la structure de synchronisation du STATGTA avec le perimetre */
   if (n_InitSync(&bd_SyncSTATGTA, "ESTM7615_I3") == ERR) {
...
/* Initialisation de la structure de synchronisation du ARCSTATGTA avec le perimetre */
   if (n_InitSync(&bd_SyncARCSTATGTA, "ESTM7615_I4") == ERR) {
...
/* Lancement du traitement du fichier maitre */
   ...
   if (n_CloseFileAppl("ESTM7615_I1", &(bd_Rupture.pf_InputFil)) == ERR) {
      ExitPgm(ERR_XX, "Erreur appel fonction n_CloseFileAppl");
   }

   if (n_CloseFileAppl("ESTM7615_I2", &(bd_SyncGTA.pf_InputFil)) == ERR) {
      ExitPgm(ERR_XX, "Erreur appel fonction n_CloseFileAppl");
   }

   if (n_CloseFileAppl("ESTM7615_I3", &(bd_SyncSTATGTA.pf_InputFil)) == ERR) {
      ExitPgm(ERR_XX, "Erreur appel fonction n_CloseFileAppl");
   }

   if (n_CloseFileAppl("ESTM7615_I4", &(bd_SyncARCSTATGTA.pf_InputFil)) == ERR) {
      ExitPgm(ERR_XX, "Erreur appel fonction n_CloseFileAppl");
   }

   if (n_CloseFileAppl("ESTM7615_I5", &(Kpf_InputFilIRD)) == ERR) {
      ExitPgm(ERR_XX, "Erreur appel fonction n_CloseFileAppl ESTM7615_I5");
   }

   if (n_CloseFileAppl("ESTM7615_O1", &Kp_OutputFileDom) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_CloseFileApplDom");
   }

   if (n_CloseFileAppl("ESTM7615_O2", &Kp_OutputFileVie) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_CloseFileApplVie");
   }

   if (n_CloseFileAppl("ESTM7615_O3", &Kp_OutputFileAno) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_CloseFileApplAno");
   }

   if (n_CloseFileAppl("ESTM7615_O4", &Kp_OutputFileGTAR) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_CloseFileApplAno");
   }
...
)
{
   ...
   if (n_OpenFileAppl("ESTM7615_I1", "rt", &(pbd_Rupture->pf_InputFil)) == ERR) {
      RETURN_VAL(ERR);
   }

   if (n_OpenFileAppl("ESTM7615_I5", "rt", &(Kpf_InputFilIRD)) == ERR) {
      RETURN_VAL(ERR);
   }
