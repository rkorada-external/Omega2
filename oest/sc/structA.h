...
[033] 30/08/2018 JYP           : IFRS17 req 10.6 : ajout du IFRS17 priced flg/amount dans le PERICASE 
[034] 08/10/2018 MZM           :spira:70671 : Ajout Colonne Montant Retro Net Premium pour le Calcul des FUTURES RETRO PREMIUM et CLAIMS
==============================================================================*/
#ifndef __STRUCT
#define __STRUCT
...
#define NB_MAX_PILOT    200000

#define MAX_LIFDRI 200000
...
#define PER_ACCFAM_CT       195   // [027]
#define PER_ESTV2C_COL_21   196
#define PER_ESTV2C_COL_22   197
#define PER_ESTV2C_COL_23   198
#define PER_ESTV2C_COL_24   199
#define PER_PRC_FLG_CT		200	  // [033]
#define PER_IPLR_R   		201   // [033]
#define PER_FLAPROPRM_M     202   // [034]   
...
typedef struct {
  ...
  double    LOSRAT_R ;
  char      AMORAT_CT ;
  char      SEGTYP_CT ; // [033] JYP IFRS17 req 10.6
} T_SEGEST_SOLVENCY ;
