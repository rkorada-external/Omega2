...

{
	...
	sprintf( MsgAno, "The Acceptance currency %s of the Accounting Transaction (Subsidary %s - Balancesheet year %s - Contract %s - End %s - Sec %s - UWY %s - UW %s) doesn't exist in the exchange currency table BREF..TCURQUOT\n",
