...
---------------------------------------------------------------------------------------------------
DESCRIPTION :
	THIS PROGRAM AIMS TO HANDLE IFRS17 REVENUE CALCULATION FOR RETRO P CONTRACTS
---------------------------------------------------------------------------------------------------
CHANGE HISTORY :
...
int main( int argc,  char *argv[] )
{
	...
	if ( n_OpenFileAppl ( "ESFC3692D_O1","wt",&Kp_OutputFil_FILE ) == ERR )
		ExitPgm( ERR_XX , "" );
	...
	/***************************************************************************/
	if ( n_CloseFileAppl( "ESFC3692D_I1", &( Kbd_Rup_FILE.pf_InputFil ) ) == ERR )
		ExitPgm( ERR_XX , "" );
	
	if ( n_CloseFileAppl( "ESFC3692D_O1", &Kp_OutputFil_FILE ) == ERR ) 
		ExitPgm( ERR_XX , "" );
...
int n_Init_FILE(T_RUPTURE_VAR  *pbd_Rupt)
{
	...
	if ( n_OpenFileAppl ("ESFC3692D_I1", "rt", &(pbd_Rupt->pf_InputFil)))
		RETURN_VAL (ERR);
