...
[003] 27/09/2012 Florent :spot:24041 copie du ESTM1004 pour le step 02 du ESID3705 pour sortir TOUTES LES LIGNES DU PÉRIMÈTRES !
==============================================================================*/
/*--------------------------------------------------*/
...
/* Ouverture des fichiers de sortie */
   if (n_OpenFileAppl("ESTM1009_O1", "wt", &Kp_OutputFile1) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_OpenFileAppl");
   }

   if (n_OpenFileAppl("ESTM1009_O2", "wt", &Kp_OutputFile2) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_OpenFileAppl");
   }

   if (n_OpenFileAppl("ESTM1009_O3", "wt", &Kp_OutputFile3) == ERR) {   // [002]
      ExitPgm(ERR_XX , "Erreur appel fonction n_OpenFileAppl");
   }
...
/* Lancement du traitement du fichier maitre */
   ...
   if (n_CloseFileAppl("ESTM1009_I1", &(pbd_Rupture->pf_InputFil)) == ERR) {
      ExitPgm(ERR_XX, "Erreur appel fonction n_CloseFileAppl");
   }

   if (n_CloseFileAppl("ESTM1009_I2", &(pbd_Sync->pf_InputFil)) == ERR) {
      ExitPgm(ERR_XX, "Erreur appel fonction n_CloseFileAppl");
   }

   if (n_CloseFileAppl("ESTM1009_O1", &Kp_OutputFile1) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_CloseFileAppl");
   }

   if (n_CloseFileAppl("ESTM1009_O2", &Kp_OutputFile2) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_CloseFileAppl");
   }

   if (n_CloseFileAppl("ESTM1009_O3", &Kp_OutputFile3) == ERR) {    // [002]
      ExitPgm(ERR_XX , "Erreur appel fonction n_CloseFileAppl");
   }
...
/* Ouverture du fichier maitre */
   if (n_OpenFileAppl("ESTM1009_I1", "rt", &(pbd_Rupture->pf_InputFil)) == ERR) {
      RETURN_VAL(ERR);
   }
...
/* Ouverture du fichier esclave */
   if (n_OpenFileAppl("ESTM1009_I2", "rt", &(pbd_Sync->pf_InputFil)) == ERR) {
      RETURN_VAL(ERR);
   }
...
)
{
   ...
   RETURN_VAL(strcmp(ptsz_LigneMaitre[PER_SEC_NF], ptsz_LigneEsclave[CTRGRO_SEC_NF]));
}
...
int n_ActionFilsSansPere(char *ptsz_LigneEsclave[])
{
   ...
   fprintf(Kp_OutputFile2, "CTR %s, END %s, SEC %s not in IADPERICASE\n",
