...
int main(int argc  , char *argv[])
{
    ...
    if ( n_OpenFileAppl ( "ESTC2131bis_O1","wt", &fp_Fichier_GT_SORTIE ) == ERR )               ExitPgm( ERR_XX , "" ) ;
    if ( n_OpenFileAppl ( "ESTC2131bis_O2","wt", &fp_FichierLog_TermineComptable ) == ERR )     ExitPgm( ERR_XX , "" ) ;
    if ( n_OpenFileAppl ( "ESTC2131bis_O3","wt", &fp_FichierLog_RetroPasPlacement ) == ERR )    ExitPgm( ERR_XX , "" ) ;
    ...
    if ( n_CloseFileAppl( "ESTC2131bis_I4", &( bd_RuptPLC.pf_InputFil ) )      == ERR ) ExitPgm( ERR_XX , "" ) ;
    if ( n_CloseFileAppl( "ESTC2131bis_I3", &( bd_RuptIARPERIM.pf_InputFil ) ) == ERR ) ExitPgm( ERR_XX , "" ) ;
    if ( n_CloseFileAppl( "ESTC2131bis_I2", &( bd_RuptIAVPERIM.pf_InputFil ) ) == ERR ) ExitPgm( ERR_XX , "" ) ;
    if ( n_CloseFileAppl( "ESTC2131bis_I1", &( bd_RuptGT.pf_InputFil ) )       == ERR ) ExitPgm( ERR_XX , "" ) ;
    if ( n_CloseFileAppl( "ESTC2131bis_O3", &fp_FichierLog_RetroPasPlacement ) == ERR ) ExitPgm( ERR_XX , "" ) ;
    if ( n_CloseFileAppl( "ESTC2131bis_O2", &fp_FichierLog_TermineComptable )  == ERR ) ExitPgm( ERR_XX , "" ) ;
    if ( n_CloseFileAppl( "ESTC2131bis_O1", &fp_Fichier_GT_SORTIE )            == ERR ) ExitPgm( ERR_XX , "" ) ;
...
int n_InitGT( T_RUPTURE_VAR *RuptGT )
{
    ...
    if ( n_OpenFileAppl( "ESTC2131bis_I1", "rt", &( RuptGT->pf_InputFil ) ) == ERR )      return ERR ;
...
int n_InitAVPERIMETRE( T_RUPTURE_SYNC_VAR *RuptSyncAVPERIMETRE)
{
    ...
    if ( n_OpenFileAppl( "ESTC2131bis_I2", "rt", &( RuptSyncAVPERIMETRE->pf_InputFil ) ) )     return ERR;
...
int n_InitARPERIMETRE( T_RUPTURE_SYNC_VAR *RuptSyncARPERIMETRE)
{
    ...
    // ouverture du fichier maitre perimetre
    if ( n_OpenFileAppl( "ESTC2131bis_I3", "rt", &( RuptSyncARPERIMETRE->pf_InputFil ) ) )     return ERR;
...
int n_InitPLACEMENT ( T_RUPTURE_SYNC_VAR *RuptSyncPLACEMENT)
{
    ...
    // ouverture du fichier maitre perimetre
    if ( n_OpenFileAppl( "ESTC2131bis_I4", "rt", &( RuptSyncPLACEMENT->pf_InputFil ) ) )     return ERR;
