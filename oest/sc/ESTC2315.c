...
[18] 20/01/2025 JYP  SPIRA 112635: fix regression from previous spira life 111435, commit old spira 111344 again :exclusion of Openning AE I17X 
[19] 16/07/2025 M.NAJI  : US 5559 SERQS - RA/SAP interface -Phase 1 , update MAX_SSDACTR
...
static char VERSION_ESTC2315_C[151] = "__version__: ESTC2315.c version [018] 20/01/2025 exclusion AE openning internal assumed I17X/EBS " ;
...
//[16]
  ...
  if ( n_OpenFileAppl ( "ESTC2315_I3", "rb", &Kp_InputFilSsdActr ) == ERR )
    ExitPgm( ERR_XX , "" ) ;

  /* ouverture du fichier binaire en entree des postes comptables */
  if ( n_OpenFileAppl ( "ESTC2315_I4", "rb", &Kp_InputFilDetTrs ) == ERR )
    ExitPgm( ERR_XX , "" ) ;

  /* ouverture du fichier en sortie GT */
  if ( n_OpenFileAppl ( "ESTC2315_O1", "wt", &Kp_OutputFilGt ) == ERR )
    ExitPgm( ERR_XX , "" ) ;

  /* ouverture du fichier en sortie GT */
  if ( n_OpenFileAppl ( "ESTC2315_O2", "wt", &Kp_OutputFilGt2 ) == ERR )
    ExitPgm( ERR_XX , "" ) ;
  ...
  if ( n_CloseFileAppl( "ESTC2315_I1", &( bd_RuptGtrr.pf_InputFil ) ) == ERR )
    ExitPgm( ERR_XX , "" ) ;

  if ( n_CloseFileAppl( "ESTC2315_I2", &( bd_RuptPlc.pf_InputFil ) ) == ERR )
    ExitPgm( ERR_XX , "" ) ;

  if ( n_CloseFileAppl( "ESTC2315_I3", &Kp_InputFilSsdActr ) == ERR )
    ExitPgm( ERR_XX , "" ) ;

  if ( n_CloseFileAppl( "ESTC2315_I4", &Kp_InputFilDetTrs ) == ERR )
    ExitPgm( ERR_XX , "" ) ;

  if ( n_CloseFileAppl( "ESTC2315_O1", &Kp_OutputFilGt ) == ERR )
    ExitPgm( ERR_XX , "" ) ;

  if ( n_CloseFileAppl( "ESTC2315_O2", &Kp_OutputFilGt2 ) == ERR )
    ExitPgm( ERR_XX , "" ) ;
...
int n_InitGtrr(T_RUPTURE_VAR  *pbd_Rupt)
{
  ...
  if ( n_OpenFileAppl( "ESTC2315_I1", "rt", &( pbd_Rupt->pf_InputFil ) ) )
    return ERR ;
...
int n_ActionLigneGtrr( char **ptb_InRec_Cur )
{
  ...
  if ( (Kc_PLA_SSDRTO_B == '1' && fabs(atof(ptb_InRec_Cur[GT_RETAMT_M])) >= 0.001 ) 
       && (  
      ...
      )
  {
    ...
    else
    {
      ...
      if ( strcmp(Ksz_typetrt_ct, "GT_SII") != 0 )
      {
        ...
        fprintf( Kp_OutputFilGt, "%d~~%s~%s~%s~%s~~%s~%d~%d~%d~%d~%s~%s~%s~%s~%s~%s~%-.3lf~%d~~%d~A~~~~~~~~~~~~~~~~~~%s~%s~%s~%s~%s~%s~%s~%s\n",//[12]
      ...
      fprintf( Kp_OutputFilGt, "%d~~%s~%s~%s~%s~~%s~%d~%d~%d~%d~%s~%s~%s~%s~%s~%s~%-.3lf~%d~~%d~A~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%-.3lf~%d~%d~%s~%s~%s~%-.3lf~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s~%s%s~%s~%s~%s~%s~%d~%s~%s~%s~%s~%s~%s~%s~%s\n",  //[009]//[12]
                 Ktbd_SsdActr[i].RTOSSD_CF,
                 ptb_InRec_Cur[GT_BALSHEY_NF],
                 ptb_InRec_Cur[GT_BALSHRMTH_NF],
                 ptb_InRec_Cur[GT_BALSHRDAY_NF],
...
int n_InitPlc( T_RUPTURE_SYNC_VAR  *pbd_Rupt )
{
  ...
  if ( n_OpenFileAppl( "ESTC2315_I2", "rt", &( pbd_Rupt->pf_InputFil ) ) == ERR )
    return ERR ;
