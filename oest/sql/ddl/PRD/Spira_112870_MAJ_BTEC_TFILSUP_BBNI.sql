...
delete   BTEC..TFILSUP where dom_cf in ('BBNI_EBS', '4000_EBS')      
                                                                                       
insert into BTEC..TFILSUP values('BBNI_EBS', 122,	'USA1') -- AEL USA1                  
insert into BTEC..TFILSUP values('BBNI_EBS', 222,	'FRA1') -- AEL FRA1                  
insert into BTEC..TFILSUP values('BBNI_EBS', 322,	'SGP1') -- AEL SGP1       

insert into BTEC..TFILSUP values('4000_EBS', 127,	'USA1') -- AEL USA1                  
insert into BTEC..TFILSUP values('4000_EBS', 227,	'FRA1') -- AEL FRA1                  
insert into BTEC..TFILSUP values('4000_EBS', 327,	'SGP1') -- AEL SGP1                  
