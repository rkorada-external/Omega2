...
DELETE FROM BEST..TI17PERMFIL  where IDF_CT='I17G_RAD_CKI_INI' and PERMFIL_CT in ('ESF_IADVPERICASE_P','ESF_IRDPERICASE_NP')
...
DELETE FROM BEST..TI17PERMFIL  where IDF_CT='I17G_CSF_ALL_INI' and PERMFIL_CT in ('EST_IRDPERICASE0','ESF_IADVPERICASE_P','ESF_IRDPERICASE_NP','ESF_DLDGTR_P','ESF_DLDGTR_NP')
...
insert into BEST..TI17PERMFIL values ('I17G_CSF_ALL_INI',  'ESF_DLDGTR_P','${DFILP}/${PCH}ESFD2550_DLDGTR${TYPEINV0}_P.dat','I','')
insert into BEST..TI17PERMFIL values ('I17G_CSF_ALL_INI',  'ESF_DLDGTR_NP','${DFILP}/${PCH}ESFD2570_DLDGTR${TYPEINV0}_NP.dat','I','')
...
and IDF_CT in ('ESPD0060', 'ESPD8000')

insert into BEST..TI17PERMFIL values ('ESPD0060',  'EPO_FCTREST_LOADCTL','${DFILP}/${ENV_PREFIX}_ESPD0060_FCTREST_LOADCTL.dat','O','')
insert into BEST..TI17PERMFIL values ('ESPD8000',  'EPO_FCTREST_LOADCTL','${DFILP}/${ENV_PREFIX}_ESPD0060_FCTREST_LOADCTL.dat','I','')
