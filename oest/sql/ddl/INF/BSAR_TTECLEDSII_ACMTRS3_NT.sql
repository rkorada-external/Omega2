...
insert into #tletter values (1, 'A')
insert into #tletter values (2, 'B')
insert into #tletter values (3, 'C')
insert into #tletter values (4, 'D')
insert into #tletter values (5, 'E')
insert into #tletter values (6, 'F')
insert into #tletter values (7, 'H')
insert into #tletter values (8, 'P')
insert into #tletter values (9, 'S')
insert into #tletter values (10, 'T')
...
while (SELECT COUNT(1) FROM #tletter) < 11
begin 
