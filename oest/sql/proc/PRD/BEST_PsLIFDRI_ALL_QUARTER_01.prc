USE BEST
go
IF OBJECT_ID('dbo.PsLIFDRI_ALL_QUARTER_01') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.PsLIFDRI_ALL_QUARTER_01
    IF OBJECT_ID('dbo.PsLIFDRI_ALL_QUARTER_01') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.PsLIFDRI_ALL_QUARTER_01 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.PsLIFDRI_ALL_QUARTER_01 >>>'
END
go
/*
...
create procedure dbo.PsLIFDRI_ALL_QUARTER_01
	(
...
RETURN 0
go
EXEC sp_procxmode 'dbo.PsLIFDRI_ALL_QUARTER_01', 'unchained'
go
IF OBJECT_ID('dbo.PsLIFDRI_ALL_QUARTER_01') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.PsLIFDRI_ALL_QUARTER_01 >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.PsLIFDRI_ALL_QUARTER_01 >>>'
go
GRANT EXECUTE ON dbo.PsLIFDRI_ALL_QUARTER_01 TO GOMEGA
go
GRANT EXECUTE ON dbo.PsLIFDRI_ALL_QUARTER_01 TO GDBBATCH
go
