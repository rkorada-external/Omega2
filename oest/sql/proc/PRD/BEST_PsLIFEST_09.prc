USE BEST
go
IF OBJECT_ID('dbo.PsLIFEST_09') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.PsLIFEST_09
    IF OBJECT_ID('dbo.PsLIFEST_09') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.PsLIFEST_09 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.PsLIFEST_09 >>>'
END
go
...
return 0
go
EXEC sp_procxmode 'dbo.PsLIFEST_09', 'unchained'
go
IF OBJECT_ID('dbo.PsLIFEST_09') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.PsLIFEST_09 >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.PsLIFEST_09 >>>'
go
GRANT EXECUTE ON dbo.PsLIFEST_09 TO GOMEGA
go
GRANT EXECUTE ON dbo.PsLIFEST_09 TO GDBBATCH
go
