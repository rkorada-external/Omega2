...
IF OBJECT_ID('dbo.PsPeriFCT_EBS_INI_05') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.PsPeriFCT_EBS_INI_05
    IF OBJECT_ID('dbo.PsPeriFCT_EBS_INI_05') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.PsPeriFCT_EBS_INI_05 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.PsPeriFCT_EBS_INI_05 >>>'
END
go
/*
...
create procedure PsPeriFCT_EBS_INI_05
     (
       @p_segtyp_ct           char(1),
       @p_ssd_cf              USSD_CF,
       @p_seg_d               char(8),
...
Programme: PsPeriFCT_EBS_INI_05
...
Test:
BEST..PsPeriFCT_EBS_INI_05 '1' , 2 , '20180501' 
...
go
IF OBJECT_ID('dbo.PsPeriFCT_EBS_INI_05') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.PsPeriFCT_EBS_INI_05 >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.PsPeriFCT_EBS_INI_05 >>>'
go
GRANT EXECUTE ON dbo.PsPeriFCT_EBS_INI_05 TO GOMEGA
go
GRANT EXECUTE ON dbo.PsPeriFCT_EBS_INI_05 TO GDBBATCH
go
