 ...
 *
 * DROP PROC dbo.PdTSEGEST_01
*/

IF OBJECT_ID('dbo.PdTSEGEST_01') IS NOT NULL
   BEGIN
   DROP PROC dbo.PdTSEGEST_01
   PRINT '<<< DROPPED PROC dbo.PdTSEGEST_01 >>>'
END
go
...
Programme: PdTSEGEST_01

Fichier script associé : BEST_PdTSEGEST_01
...
Description du programme:
      ...
      * Supression d'enregistrements dans TSEGEST
...
Select @Vide = ""
Select @SelectParm1 = "D"                            -- U = Insert / Update , D = Delete
...
exec sp_SCOR_INSPRC 'ESISUP01', 'PdTSEGEST_01', 'BEST', 'ME01'
go

IF OBJECT_ID('dbo.PdTSEGEST_01') IS NOT NULL
   PRINT '<<< CREATED PROC dbo.PdTSEGEST_01 >>>'
ELSE
   PRINT '<<< FAILED CREATING PROC dbo.PdTSEGEST_01 >>>'
go
/*
 * Granting/Revoking Permissions on dbo.PdTSEGEST_01
 */
GRANT EXECUTE ON dbo.PdTSEGEST_01 TO GOMEGA
go
