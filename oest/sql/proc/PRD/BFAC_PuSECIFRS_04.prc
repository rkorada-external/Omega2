...
Description du programme:
    Update data in BFAC..TSECIFRS using data from BTRAV..ESFD8000_TSECIFRS for multi-year contracts
Parametres:
	@norme_cf char(4)
 	@p_erreur varchar(64)=null output
...
BEGIN
	...
	FROM BTRAV..ESFD8000_TSECIFRS A, BFAC..TSECIFRS B 
...
BEGIN
	...
	FROM BTRAV..ESFD8000_TSECEBSINI A, BFAC..TSECIFRS B 
	WHERE A.CTR_NF = B.CTR_NF
	AND A.UWY_NF = B.UWY_NF
	AND A.UW_NT = B.UW_NT
	AND A.END_NT = B.END_NT
