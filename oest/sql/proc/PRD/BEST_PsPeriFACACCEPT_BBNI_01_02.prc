use BEST
go
if object_id('PsPeriFACACCEPT_BBNI_01_02') is not null
begin
   drop procedure PsPeriFACACCEPT_BBNI_01_02
   if object_id('PsPeriFACACCEPT_BBNI_01_02') is not null
     print '<<< FAILED DROPPING procedure PsPeriFACACCEPT_BBNI_01_02 >>>'
   else
     print '<<< DROPPED procedure PsPeriFACACCEPT_BBNI_01_02 >>>' 
end

go
create procedure PsPeriFACACCEPT_BBNI_01_02
(
...
go
if object_id('PsPeriFACACCEPT_BBNI_01_02') is not null
  print '<<< CREATED procedure PsPeriFACACCEPT_BBNI_01_02 >>>'
else
  print '<<< FAILED CREATING procedure PsPeriFACACCEPT_BBNI_01_02 >>>'
go
grant execute on PsPeriFACACCEPT_BBNI_01_02 TO GDBBATCH, GOMEGA
go
