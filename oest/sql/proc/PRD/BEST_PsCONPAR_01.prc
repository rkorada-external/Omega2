...
Go
/*
 * DROP PROC dbo.PsCONPAR_01
*/
IF OBJECT_ID('dbo.PsCONPAR_01') IS NOT NULL
   BEGIN
   DROP PROC dbo.PsCONPAR_01
   PRINT '<<< DROPPED PROC dbo.PsCONPAR_01 >>>'
END
go
...
IF OBJECT_ID('dbo.PsCONPAR_01') IS NOT NULL
   PRINT '<<< CREATED PROC dbo.PsCONPAR_01 >>>'
ELSE
   PRINT '<<< FAILED CREATING PROC dbo.PsCONPAR_01 >>>'
go
/*
 * Granting/Revoking Permissions on dbo.PsCONPAR_01
 */
GRANT EXECUTE ON dbo.PsCONPAR_01 TO GOMEGA
go
GRANT EXECUTE ON dbo.PsCONPAR_01 TO GDBBATCH
go
