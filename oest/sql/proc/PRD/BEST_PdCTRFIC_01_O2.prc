USE BEST
go
IF OBJECT_ID('dbo.PdCTRFIC_01_O2') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.PdCTRFIC_01_O2
    IF OBJECT_ID('dbo.PdCTRFIC_01_O2') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.PdCTRFIC_01_O2 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.PdCTRFIC_01_O2 >>>'
END
go
/*
...
create procedure dbo.PdCTRFIC_01_O2
     (
...
return @erreur
go
EXEC sp_procxmode 'dbo.PdCTRFIC_01_O2', 'unchained'
go
IF OBJECT_ID('dbo.PdCTRFIC_01_O2') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.PdCTRFIC_01_O2 >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.PdCTRFIC_01_O2 >>>'
go
GRANT EXECUTE ON dbo.PdCTRFIC_01_O2 TO GOMEGA
go
