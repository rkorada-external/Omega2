...
Go
 ...
 /* DROP PROC dbo.PuI17REQJOBPLAN_01
*/
IF OBJECT_ID('dbo.PuI17REQJOBPLAN_01') IS NOT NULL
   BEGIN
   DROP PROC dbo.PuI17REQJOBPLAN_01
   PRINT '<<< DROPPED PROC dbo.PuI17REQJOBPLAN_01 >>>'
END
go
...
create procedure PuI17REQJOBPLAN_01
     (	
...
Programme: PuI17REQJOBPLAN_01
Fichier script associé : BEST_PuI17REQJOBPLAN_01.prc
Domaine : (ES) Estimation
Base principale : BEST
Version: 1.0
Auteur: L.DOAN
Date de creation:  19/02/2020

Description du programme: 
	- Mise a jour de la date de traitement ( LAUNCH_D ) dans BEST..I17REQJOBPLAN 
          pour les filiales d'un inventaire IFRS17 Group
...
[004] 18/05/2021 L. DOAN     :spira:96383 - SAP posting request not closed after closing
*****************************************************/
...
(A.REQCOD_CT like @recod OR A.REQCOD_CT = 'S')
and   A.LAUNCH_D     = NULL
...
IF OBJECT_ID('dbo.PuI17REQJOBPLAN_01') IS NOT NULL
   PRINT '<<< CREATED PROC dbo.PuI17REQJOBPLAN_01 >>>'
ELSE
   PRINT '<<< FAILED CREATING PROC dbo.PuI17REQJOBPLAN_01 >>>'
go
/*
 * Granting/Revoking Permissions on dbo.PuI17REQJOBPLAN_01
 */
GRANT EXECUTE ON dbo.PuI17REQJOBPLAN_01 TO GOMEGA
go
GRANT EXECUTE ON dbo.PuI17REQJOBPLAN_01 TO GDBBATCH
go
