use BEST
go
if object_id('BEST.dbo.PiSEGBA_01') is not null
begin
...
10 Florent 11/05/2017 :spira:58025 ajout de la version de la segmentation
11 Charles 17/08/2018 :BJTD-CLO-905316 EXT-IFRS17-903277 - REQ 03.05 ajout du segment type
12 JYP     17/11/2022 :spira:xxxx regression IFRS4 ratio from spira 104409 
13 JYP     18/06/2024 :spira 111723 : do not update TSEGEST when closing job
********************************************************************************/
--modif11
...
--- convert ratio format only when file is loaded by user
if @caller_flag = 'U'
begin 
