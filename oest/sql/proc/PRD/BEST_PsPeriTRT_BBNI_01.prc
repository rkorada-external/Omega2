use BEST
go
if object_id('PsPeriTRT_BBNI_01') is not null
begin
   drop procedure PsPeriTRT_BBNI_01
   if object_id('PsPeriTRT_BBNI_01') is not null
     print '<<< FAILED DROPPING procedure PsPeriTRT_BBNI_01 >>>'
   else
     print '<<< DROPPED procedure PsPeriTRT_BBNI_01 >>>' 
end

go
create procedure PsPeriTRT_BBNI_01
(
...
_________________
MODIFICATIONS
[001] 04/07/2025 : US 6066 BBNI - missing calculation on treaties Fix UAT EGPI non renseigne 
*****************************************************/
declare @erreur int
...
go
if object_id('PsPeriTRT_BBNI_01') is not null
  print '<<< CREATED procedure PsPeriTRT_BBNI_01 >>>'
else
  print '<<< FAILED CREATING procedure PsPeriTRT_BBNI_01 >>>'
go
grant execute on PsPeriTRT_BBNI_01 TO GDBBATCH, GOMEGA
go
