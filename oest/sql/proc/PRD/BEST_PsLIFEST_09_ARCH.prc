USE BEST
go
IF OBJECT_ID('dbo.PsLIFEST_09_ARCH') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.PsLIFEST_09_ARCH
    IF OBJECT_ID('dbo.PsLIFEST_09_ARCH') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.PsLIFEST_09_ARCH >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.PsLIFEST_09_ARCH >>>'
END
go
...
create procedure PsLIFEST_09_ARCH
(
...
return 0
go
EXEC sp_procxmode 'dbo.PsLIFEST_09_ARCH', 'unchained'
go
IF OBJECT_ID('dbo.PsLIFEST_09_ARCH') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.PsLIFEST_09_ARCH >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.PsLIFEST_09_ARCH >>>'
go
GRANT EXECUTE ON dbo.PsLIFEST_09_ARCH TO GOMEGA
go
GRANT EXECUTE ON dbo.PsLIFEST_09_ARCH TO GDBBATCH
go
