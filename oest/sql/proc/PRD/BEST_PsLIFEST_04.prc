 ...
 *
 * DROP PROC dbo.PsLIFEST_04
*/

IF OBJECT_ID('dbo.PsLIFEST_04') IS NOT NULL
   BEGIN
   DROP PROC dbo.PsLIFEST_04
   PRINT '<<< DROPPED PROC dbo.PsLIFEST_04 >>>'
END
go
...
Programme: PsLIFEST_04

Fichier script associé : ESSLIF04.PRC
...
Description: SPOT 18754 : FILTRER LES POSTES par taccpar
...
select  '', H.PRS_CF, H.ACMTRS_NT, R.POSITION_NT, H.ACMTRS_LL,
        ...
        0, 0, 0, 0
from    BREF..TACMTRSH H, BEST..TACCPAR R
...
exec sp_SCOR_INSPRC 'ESSLIF04', 'PsLIFEST_04', 'BEST', 'ME01'
go

IF OBJECT_ID('dbo.PsLIFEST_04') IS NOT NULL
   PRINT '<<< CREATED PROC dbo.PsLIFEST_04 >>>'
ELSE
   PRINT '<<< FAILED CREATING PROC dbo.PsLIFEST_04 >>>'
go
/*
 * Granting/Revoking Permissions on dbo.PsLIFEST_04
 */
GRANT EXECUTE ON dbo.PsLIFEST_04 TO GOMEGA
go
