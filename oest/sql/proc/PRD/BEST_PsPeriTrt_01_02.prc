...
drop procedure dbo.PsPeriTrt_01_02
go

create procedure PsPeriTrt_01_02
--(
...
** Date de creation         : 11/03/2019
** Description du programme : Descente du périmètre acceptation traités au niveau CASEX sans filtre sur la date d'effet.
** Conditions d'execution   :
** Commentaires             :
** __________________________
** Modification : [001] - Spira 64222 - ajout de nouveaux champs dans le pericase et mofifier les calcule EST41.
** Author       : B.LAGHA
** Date de modif: 11/03/2019
...
GRANT EXECUTE ON dbo.PsPeriTrt_01_02 TO GOMEGA
go
GRANT EXECUTE ON dbo.PsPeriTrt_01_02 TO GDBBATCH
go
