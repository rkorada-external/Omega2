...
IF OBJECT_ID('dbo.PsCONTR_17') IS NOT NULL
BEGIN
    DROP PROC dbo.PsCONTR_17
    PRINT '<<< DROPPED PROC dbo.PsCONTR_17 >>>'
END
go
...
Programme: PsCONTR_17

Fichier script associé : ESSCTR17.PRC
...
go
IF OBJECT_ID('dbo.PsCONTR_17') IS NOT NULL
    PRINT '<<< CREATED PROC dbo.PsCONTR_17 >>>'
ELSE
    PRINT '<<< FAILED CREATING PROC dbo.PsCONTR_17 >>>'
go
/*
 * Granting/Revoking Permissions on dbo.PsCONTR_17
 */
GRANT EXECUTE ON dbo.PsCONTR_17 TO GOMEGA
go
