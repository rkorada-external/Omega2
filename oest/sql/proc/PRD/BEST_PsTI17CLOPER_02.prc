...
IF OBJECT_ID('dbo.PsTI17CLOPER_02') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.PsTI17CLOPER_02
    IF OBJECT_ID('dbo.PsTI17CLOPER_02') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.PsTI17CLOPER_02 >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.PsTI17CLOPER_02 >>>'
END
go

create procedure dbo.PsTI17CLOPER_02(
		@norme_cf char(4),
...
IF OBJECT_ID('dbo.PsTI17CLOPER_02') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.PsTI17CLOPER_02 >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.PsTI17CLOPER_02 >>>'
go

GRANT EXECUTE ON dbo.PsTI17CLOPER_02 TO GOMEGA
go

GRANT EXECUTE ON dbo.PsTI17CLOPER_02 TO GDBBATCH
go
