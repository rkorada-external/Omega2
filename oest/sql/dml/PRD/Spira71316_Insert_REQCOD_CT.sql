...
insert #TVAL values('E','REQCOD_CT','G','IFRS17 Grp clos. ','IFRS17 Group closing ',null)
insert #TVAL values('F','REQCOD_CT','G','IFRS17 Inv grp','IFRS17 Inventaire groupe',null)
go
...
delete bref..tbantecl where col_ls in(select COL_LS from #TQUAL) and COLVAL_CT = 'G'
delete bref..tbantec where col_ls in(select COL_LS from #TQUAL) and COLVAL_CT = 'G'
