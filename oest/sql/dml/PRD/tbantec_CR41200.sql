...
insert #TVAL values('E', 'ANO_CT', '21036', 'Life T code is unauthorized', 'Life T code.',null)

insert #TVAL values('F', 'ANO_CT', '21036', 'Post comptable vie non autorisé', 'Post comptable.',null)
...
delete from bref..tbantec where COL_LS='ANO_CT' and  COLVAL_CT IN ('21036')
