...
go
Delete  from BREF..TBANTECL where COL_LS = 'REQCOD_CT' and colval_ct in ('I', 'E', 'S', 'O')
Delete  from BREF..TBANTEC where COL_LS = 'REQCOD_CT' and colval_ct in ('I', 'E', 'S', 'O')
insert #TVAL values('E','REQCOD_CT','I','IFRS4','IFRS4',null)
insert #TVAL values('F','REQCOD_CT','I','IFRS4','IFRS4',null)
insert #TVAL values('E','REQCOD_CT','E','EBS','EBS',null)
insert #TVAL values('F','REQCOD_CT','E','EBS','EBS',null)
insert #TVAL values('E','REQCOD_CT','S','SAP','SAP',null)
insert #TVAL values('F','REQCOD_CT','S','SAP','SAP',null)
insert #TVAL values('E','REQCOD_CT','O','MI_AOC','MI_AOC',null)
insert #TVAL values('F','REQCOD_CT','O','MI_AOC','MI_AOC',null)
go
...
delete bref..tbantecl where col_ls in(select COL_LS from #TQUAL) and COLVAL_CT in ('I', 'E', 'S', 'O')
delete bref..tbantec where col_ls in(select COL_LS from #TQUAL) and COLVAL_CT in ('I', 'E', 'S', 'O')
