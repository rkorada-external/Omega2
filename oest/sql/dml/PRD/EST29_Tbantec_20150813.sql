...
insert #TVAL values('E', 'ANO_CT', '104', 'The contract/uwy is closed', 'Contract closed',null)

insert #TVAL values('F', 'ANO_CT', '104', 'Le contrat/Exercice est Terminé', 'Contrat terminé',null)
...
delete from bref..tbantecl where COL_LS='ANO_CT' and  COLVAL_CT IN ('104')
delete from bref..tbantec where COL_LS='ANO_CT' and  COLVAL_CT IN ('104')
