...
insert #TVAL values('E', 'ANO_CT', '100', 'Not existing assumed event', 'Inv Ass Evt',null)
insert #TVAL values('E', 'ANO_CT', '101', 'Invalid Event for this Claim', 'Inv Ass Evt-Clm',null)
insert #TVAL values('E', 'ANO_CT', '102', 'Not existing retro event', 'Inv Retro Evt',null)
insert #TVAL values('E', 'ANO_CT', '103', 'Invalid Event for this Claim', 'Inv Ret Evt-Clm',null)

insert #TVAL values('F', 'ANO_CT', '100', 'Evenement acceptation inexistant', 'Evt ACC invalide',null)
insert #TVAL values('F', 'ANO_CT', '101', 'Ev ACC invalide pour ce sinistre', 'Evt Sin ACC inv',null)
insert #TVAL values('F', 'ANO_CT', '102', 'Evenement retro inexistant', 'Evt RET invalide',null)
insert #TVAL values('F', 'ANO_CT', '103', 'Ev RET invalide pour ce sinistre', 'Evt Sin RET inv',null)
...
delete from bref..tbantecl where COL_LS='ANO_CT' and  COLVAL_CT IN ('100')
delete from bref..tbantecl where COL_LS='ANO_CT' and  COLVAL_CT IN ('101')
delete from bref..tbantecl where COL_LS='ANO_CT' and  COLVAL_CT IN ('102')
delete from bref..tbantecl where COL_LS='ANO_CT' and  COLVAL_CT IN ('103')
delete from bref..tbantec where COL_LS='ANO_CT' and  COLVAL_CT IN ('100')
delete from bref..tbantec where COL_LS='ANO_CT' and  COLVAL_CT IN ('101')
delete from bref..tbantec where COL_LS='ANO_CT' and  COLVAL_CT IN ('102')
delete from bref..tbantec where COL_LS='ANO_CT' and  COLVAL_CT IN ('103')
