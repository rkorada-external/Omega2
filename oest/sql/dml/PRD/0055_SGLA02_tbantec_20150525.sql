...
insert #TVAL values('E', 'TYPMOD1_CT', '12', 'Analytics', 'Analytics',null)
insert #TVAL values('F', 'TYPMOD1_CT', '12', 'Analytics', 'Analytics',null)
insert #TVAL values('G', 'TYPMOD1_CT', '12', 'Analytics', 'Analytics',null)
insert #TVAL values('I', 'TYPMOD1_CT', '12', 'Analytics', 'Analytics',null)
insert #TVAL values('S', 'TYPMOD1_CT', '12', 'Analytics', 'Analytics',null)
go
...
delete from bref..tbantecl where COL_LS='TYPMOD1_CT' and  COLVAL_CT IN ('12')
print 'delete from bref..tbanall'
delete bref..tbanall where COL_LS='TYPMOD1_CT' and  COLVAL_CT IN ('12')
print 'delete from bref..tbanal'
delete bref..tbanal where COL_LS='TYPMOD1_CT' and  COLVAL_CT IN ('12')
print 'delete from bref..tbantec'
delete from bref..tbantec where COL_LS='TYPMOD1_CT' and  COLVAL_CT IN ('12')
go

print 'insert bref..tbantec'
insert bref..tbantec
select a.COL_LS,b.COLVAL_CT,ACTCOD_B=1,b.CODVALSSD_CF,user,null,1
from #TQUAL a, #TVAL b
...
select c.LAGI_CF,a.COL_LS,b.COLVAL_CT,b.COLVAL_LM,b.COLVAL_LS,b.CODVALSSD_CF,user,null
