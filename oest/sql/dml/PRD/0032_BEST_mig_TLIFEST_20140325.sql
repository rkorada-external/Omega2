...
declare @p_balshtyea_nf	 smallint
select @p_balshtyea_nf=2013
...
select 
       ...
       a.SSD_CF,
       a.CUR_CF,
       0 ESTMNT_M,  --isnull(convert(decimal(18,3),ESTMNT_M * RATIO), 0) ESTMNT_M,
       a.INDSUP_B,
       ' ' lob_cf,
       "COMPTA" ORICOD_LS,
       a.CREUSR_CF,
...
INSERT INTO #TACCPAR_USER (ACMTRS_NT,DETTRNCOD_CF) VALUES(1900,'01900')
INSERT INTO #TACCPAR_USER (ACMTRS_NT,DETTRNCOD_CF) VALUES(1901,'01901')
