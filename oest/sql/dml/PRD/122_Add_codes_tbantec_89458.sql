...
insert #TVAL values('E','ESTUPLDSTS_CT ','0','Waiting','Waiting',null)
insert #TVAL values('E','ESTUPLDSTS_CT ','1','In force','In force',null)
insert #TVAL values('E','ESTUPLDSTS_CT ','2','Closed','Closed',null)
insert #TVAL values('E','ESTUPLDSTS_CT ','5','Failed','Failed',null)
insert #TVAL values('E','ESTUPLDSTS_CT ','10','Abnormal Closed','Closed with abnormalities',null)
                         

insert #TVAL values('F','ESTUPLDSTS_CT ','0','En attente','En attente',null)
insert #TVAL values('F','ESTUPLDSTS_CT ','1','En cours','En cours',null)
insert #TVAL values('F','ESTUPLDSTS_CT ','2','Termine','Termine',null)
insert #TVAL values('F','ESTUPLDSTS_CT ','5','Echec','Echec',null)
insert #TVAL values('F','ESTUPLDSTS_CT ','10','Anomalie Termine','Termine avec anomalies',null)
                         

insert #TVAL values('G','ESTUPLDSTS_CT ','0','Waiting','Waiting',null)
insert #TVAL values('G','ESTUPLDSTS_CT ','1','In force','In force',null)
insert #TVAL values('G','ESTUPLDSTS_CT ','2','Closed','Closed',null)
insert #TVAL values('G','ESTUPLDSTS_CT ','5','Failed','Failed',null)
insert #TVAL values('G','ESTUPLDSTS_CT ','10','Abnormal Closed','Closed with abnormalities',null)
                         

insert #TVAL values('I','ESTUPLDSTS_CT ','0','En attente','En attente',null)
insert #TVAL values('I','ESTUPLDSTS_CT ','1','En cours','En cours',null)
insert #TVAL values('I','ESTUPLDSTS_CT ','2','Termine','Termine',null)
insert #TVAL values('I','ESTUPLDSTS_CT ','5','Echec','Echec',null)
insert #TVAL values('I','ESTUPLDSTS_CT ','10','Anomalie Termine','Termine avec anomalies',null)
                         
                    
insert #TVAL values('S','ESTUPLDSTS_CT ','0','En attente','En attente',null)
insert #TVAL values('S','ESTUPLDSTS_CT ','1','En cours','En cours',null)
insert #TVAL values('S','ESTUPLDSTS_CT ','2','Termine','Termine',null)
insert #TVAL values('S','ESTUPLDSTS_CT ','5','Echec','Echec',null)
insert #TVAL values('S','ESTUPLDSTS_CT ','10','Anomalie Termine','Termine avec anomalies',null)
...
go
insert #TQUAL values('ESTUPLDSTS_CT',1,1,0,0)
set nocount off
go
...
select LAGI_CF,COL_LS,case when LAGS_CF='F' then 'Statut batch ' else 'Status batch ' end,suser_name(),null
from #TQUAL, #TLAG
