...
delete from bref..tbanall where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('190')
go
delete from bref..tbanall where COL_LS='SPEENTTYP_CF' and  COLVAL_CT IN ('7')
go

print 'delete from bref..tbanal'
delete from bref..tbanal where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('190')
go
delete from bref..tbanal where COL_LS='SPEENTTYP_CF' and  COLVAL_CT IN ('7')
go
