...
insert #TVAL values('E', 'ANO_CT', '21038', 'A/C year > balance sheet year', 'ACY > Bsht year',null)
insert #TVAL values('F', 'ANO_CT', '21038', 'A/C year > annee bilan', 'A/C > annee bilan',null)
insert #TVAL values('G', 'ANO_CT', '21038', 'A/C year > balance sheet year', 'ACY > Bsht year',null)
insert #TVAL values('I', 'ANO_CT', '21038', 'A/C year > balance sheet year', 'ACY > Bsht year',null)
insert #TVAL values('S', 'ANO_CT', '21038', 'A/C year > balance sheet year', 'ACY > Bsht year',null)
...
delete from bref..tbantecl where COL_LS='ANO_CT' and  COLVAL_CT IN ('21038')


print 'delete from bref..tbantec'
delete from bref..tbantec where COL_LS='ANO_CT' and  COLVAL_CT IN ('21038')
