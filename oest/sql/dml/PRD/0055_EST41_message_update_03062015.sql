...
exec bref..PiMESSAGE_02_O2 'ESTIMATION', 5013,
     "AUTO/SEGMENTED treaty : Estimations cannot be loaded on automatic grid",
     "Le traité est 'AUTO/SEGMENTE' : Impossible de charger des estimations sur une grille automatique.", 
     0, 0
PRINT "Message ESTIMATION#5013"
