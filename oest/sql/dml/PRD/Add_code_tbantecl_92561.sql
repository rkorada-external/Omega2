...
insert #TVAL values('E','TYPMOD1_CT ','15','Auto ESIJ0810','Automatic upload ESIJ0810',null)
                         
insert #TVAL values('F','TYPMOD1_CT ','15','Auto ESIJ0810','Chargement auto ESIJ0810',null)
                         
insert #TVAL values('G','TYPMOD1_CT ','15','Auto ESIJ0810','Automatic upload ESIJ0810',null)
                         
insert #TVAL values('I','TYPMOD1_CT ','15','Auto ESIJ0810','Chargement auto ESIJ0810',null)
                         
insert #TVAL values('S','TYPMOD1_CT ','15','Auto ESIJ0810','Chargement auto ESIJ0810',null)
...
delete bref..tbantecl where col_ls in(select COL_LS from #TQUAL where TECCOD_B=1) and COLVAL_CT in (select COLVAL_CT from #TVAL )
delete bref..tbantec where col_ls in(select COL_LS from #TQUAL where TECCOD_B=1) and COLVAL_CT in (select COLVAL_CT from #TVAL )
