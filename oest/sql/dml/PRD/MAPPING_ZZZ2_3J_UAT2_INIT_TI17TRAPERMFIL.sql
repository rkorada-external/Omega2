...
----------------------------------------------------------------------------------------------------------
-- [001] 04/03/2021 M.NAJI : SPIRA 91531 Intialisation du mapping  chaine par fichier  
-- [002] 17/03/2021 CAS : SPIRA 94197 : Norm Parent en Local Run off
----------------------------------------------------------------------------------------------------------
...
-------------------------------
	...
	if not exists ( select 1 from BEST..TI17CHN where CHAIN_CT='ESFT0030')  insert into BEST..TI17CHN values ('ESFT0030',  'IFRS17 - Update run off contracts')

		-- I17G_OMG_ROC_TRA I17G_OMG_ROC_TRA

	delete BEST..TI17TRAPERMFIL where IDF_CT ='I17G_OMG_ROC_TRA'
	if not exists ( select 1 from BEST..TI17FNC where idf_ct ='I17G_OMG_ROC_TRA'  ) insert into BEST..TI17FNC values ('I17G_OMG_ROC_TRA',  'IFRS17 - GROUP - Update run off contracts')
	...
	delete BEST..TI17REQCHN where   IDF_CT = 'I17G_OMG_ROC_TRA' and  CHAIN_CT='ESFT0030'
		...
		insert into BEST..TI17REQCHN values ('I17GYPOCB',  'ESFT0030','I17G_OMG_ROC_TRA','')
				...
				-- I17P_OMG_ROC_TRA I17P_OMG_ROC_TRA
	...
	delete BEST..TI17REQCHN where   IDF_CT = 'I17P_OMG_ROC_TRA' and  CHAIN_CT='ESFT0030'
		...
		insert into BEST..TI17REQCHN values ('I17PYPOCB', 'ESFT0030','I17P_OMG_ROC_TRA','')
						...
						-- I17L_OMG_ROC_TRA I17L_OMG_ROC_TRA
