...
exec bref..PiMESSAGE_02_O2 'ESTIMATION', 2100,
     "This contract is not bookable on this Ledger.",
     "Ce contrat n'est pas comptabilisable.", 
     0, 0
PRINT "Message ESTIMATION#2100"
