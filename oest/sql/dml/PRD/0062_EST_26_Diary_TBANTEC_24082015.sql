...
delete from bref..tbantecl where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('250')

print 'delete from bref..tbanall'
delete bref..tbanall where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('250')

print 'delete from bref..tbanal'
delete bref..tbanal where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('250')

print 'delete from bref..tbantec'
delete from bref..tbantec where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('250')
