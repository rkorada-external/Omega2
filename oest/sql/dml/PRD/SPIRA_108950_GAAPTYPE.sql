...
insert #TVAL values('E','GAAPTYPE_CT','1','P&C Aggregation','P&C Aggregation',null)
insert #TVAL values('F','GAAPTYPE_CT','1','P&C Agregation','P&C Agregation',null)
insert #TVAL values('E','GAAPTYPE_CT','2','P&C Cancellation','P&C Cancellation',null)
insert #TVAL values('F','GAAPTYPE_CT','2','P&C Annulation','P&C Annulation',null)
insert #TVAL values('E','GAAPTYPE_CT','3','LIFE Aggregation','LIFE Aggregation',null)
insert #TVAL values('F','GAAPTYPE_CT','3','SGL Agregation','SGL Agregation',null)
insert #TVAL values('E','GAAPTYPE_CT','4','LIFE Cancel','LIFE Cancellation',null)
insert #TVAL values('F','GAAPTYPE_CT','4','SGL Annulation','SGL Annulation',null)
...
go
insert #TQUAL values('GAAPTYPE_CT',1,1,0,0)
...
delete bref..tbantecl where col_ls in(select COL_LS from #TQUAL)
delete bref..tbantec where col_ls in(select COL_LS from #TQUAL)
...
insert bref..tbancod select COL_LS,TECCOD_B,CODFMT_CT,CODLNG_N,CODNAT_CT,suser_name(),null,"5" from #TQUAL where COL_LS='GAAPTYPE_CT'

print 'insert bref..tbancodl'
insert bref..tbancodl
select LAGI_CF,'GAAPTYPE_CT', case when LAGS_CF='F' then 'GAAP type de mapping' else 'GAAP mapping type' end,suser_name(),null
from #TLAG
