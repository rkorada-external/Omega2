...
exec bref..PiMESSAGE_02_O2 'ESTIMATION', 21037,
     "UWY threshold greater than current Balance sheet year.",
     "Année de seuil supérieure à l'année bilan en cours.", 
     0, 0
PRINT "Message ESTIMATION#21037"
