...
insert #TVAL values('E', 'NOTIFPSTYPE_CT', '280', 'Retro contrat saisonality', 'Retro contrat saisonality',null)

insert #TVAL values('F', 'NOTIFPSTYPE_CT', '280', 'Saisonnalité contrat de retro', 'Saisonnalité contrat de retro',null)

insert #TVAL values('G', 'NOTIFPSTYPE_CT', '280', 'Retro contrat saisonality', 'Retro contrat saisonality',null)

insert #TVAL values('I', 'NOTIFPSTYPE_CT', '280', 'Retro contrat saisonality', 'Retro contrat saisonality',null)

insert #TVAL values('S', 'NOTIFPSTYPE_CT', '280', 'Retro contrat saisonality', 'Retro contrat saisonality',null)
...
delete from bref..tbantecl where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('280')

print 'delete from bref..tbanall'
delete bref..tbanall where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('280')

print 'delete from bref..tbanal'
delete bref..tbanal where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('280')

print 'delete from bref..tbantec'
delete from bref..tbantec where COL_LS='NOTIFPSTYPE_CT' and  COLVAL_CT IN ('280')
