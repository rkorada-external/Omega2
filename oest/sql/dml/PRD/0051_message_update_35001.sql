...
exec bref..PiMESSAGE_02_O2 'ESTIMATION', 20038,
     "Calculated amount is too big: it will be truncated to 999 999 999 999 999.",
     "Valeur calculée trop grande : elle est tronquée à 999 999 999 999 999.", 
     0, 0
PRINT "Message ESTIMATION#20038"
