...

{
	...
	sprintf( MsgAno, "La monnaie devise aliment %s du mouvement comptable (Filiale %s - Annee bilan %s - Contrat %s - Avenant %s - Section %s - Exercice %s - Numero ex %s) n'existe pas dans la table des cours de change de devise BREF..TCURQUOT\n",
