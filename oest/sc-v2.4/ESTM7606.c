...
/* Ouverture du fichier de sortie vie */
   if (n_OpenFileAppl("ESTM7606_O2", "wt", &Kp_OutputFileVie) == ERR) {
      ExitPgm(ERR_XX , "Erreur appel fonction n_OpenFileApplVie");
   }

/* Ouverture du fichier d'anomalies */
   if (n_OpenFileAppl("ESTM7606_O3", "wt", &Kp_OutputFileAno) == ERR) {
...
int n_ActionPereSansFils(char *ptsz_LigneMaitre[])
{
   ...
   Kc_Fichier = 'N';
   fprintf (Kp_OutputFileAno, "CTR %s, END %s, SEC %s, UWY %s,  UW %s : not in PERICASE file\n", 
