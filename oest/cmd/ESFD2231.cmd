...
#[065] 18/01/2022 : M.NAJI spira 101406 split du ESFD2220 en ESFD2200,ESFD2230 ESID2210  ==> optimisation
#[066] 22/11/2022 MZM :spira:104541 :PROD- NRT- Regressions EBS : et Undue TC '1A120222' Poste genere a tort
#[067] 04/05/2023 JYP :spira:108243 :use amount EBS overdue cancellation
#[068] 22/05/2023 JYP :spira:108243 :EBS overdue cancellation,when sumarize choose max by keys ACY/SCOSTR/SCOEND
#[069] 02/07/2024 MZM :spira:111818 - NRT July 2024 - Reinstatement Premium not calculated in IN2 (IADPERIFR ADD REILIN_NT et REIRNK_N ON THE KEY SORT)
#[070] 12/08/2024 MZM :spira:111454 - I17 - Retro P - Incorrect NDIC PC calculation when underlying is internal assumed
#[071] 19/03/2025 MZM :spira:111945 - BBNI Management
#[072] 22/01/2026 MZM :US 7847 - EBS INI Management
#==========================================================================================================================
#set -x
...
##[071] 
if [ ${IDF_CT} = "EBS_ESFD2230_BBNI" ]
then
	CLOSING_MODE="BBNI"
fi

##[072]
if [ ${IDF_CT} = "EBS_ESFD2230_INI" ]
then
        CLOSING_MODE="INI"
fi
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_125_${IB}_ESTC3604_FSTAT_O.dat 1000 1"
SORT_I2="${EST_FSTAT} 1000 1"
#SORT_I2="${DFILT}/${NCHAIN}_ESFD2003B00${IDF_CT}_125_${IB}_ESTC3604_FSTAT_O_00.dat 1000 1"
#SORT_I3="${DFILT}/${NCHAIN}_ESFD2003B01${IDF_CT}_125_${IB}_ESTC3604_FSTAT_O_01.dat 1000 1"
#SORT_I4="${DFILT}/${NCHAIN}_ESFD2003B02${IDF_CT}_125_${IB}_ESTC3604_FSTAT_O_02.dat 1000 1"
#SORT_I5="${DFILT}/${NCHAIN}_ESFD2003B03${IDF_CT}_125_${IB}_ESTC3604_FSTAT_O_03.dat 1000 1"
...
/joinkeys
       ...
       ,UWY_NF
       ,UW_NT 
/INFILE ${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_20_${IB}_SORT_IADPERICASE.dat 1000 1 "~"
/joinkeys
        PER_CTR_NF
       ,PER_END_NT
       ,PER_SEC_NF
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_100_${IB}_SORT_DLDGTAA_EBSACC.dat 1000 1"
...
#[069] Tri du fichier EST_IADPERIFR Ajout des colonnes  REILIN_NT et REIRNK_N dans la clé de TRI
...
SORT_WDIR=${DFILT}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_152_${IB}_SORT_DLCUMGTAATOT_O.dat 1000 1"
SORT_I2="${DFILT}/${NJOB}_158_${IB}_SORT_DLDGTAA_UPR_DAC.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLCUMGTAATOT_O.dat 1000 1"
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS SSD_CF  1:1 -  1:,
        ESB_CF  2:1 -  2:,
...
SORT_WDIR=${DFILT}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_159_${IB}_SORT_DLCUMGTAATOT_O.dat 1000 1"
...
NSTEP=${NJOB}_161
LIBEL="Merge EST_DLDGTAA_UPR_DAC with EBS_EOC and sort ..."
SORT_WDIR=${DFILT}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_110_${IB}_EBS_EOC.dat  2000 1"
SORT_I2="${EST_DLDGTAA_UPR_DAC} 2000 1"   
SORT_O="${DFILT}/${NSTEP}_${IB}_DLDGTAA_UPR_DAC_EOC.dat 2000 1"
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS TRNCOD_CF         6:1 -  6:,
        DBLTRNCOD_CF      7:1 -  7:,
        CTR_NF            8:1 -  8:,
...
export ${PRG}_I1=${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_20_${IB}_SORT_IADPERICASE.dat
export ${PRG}_I2=${DFILT}/${NJOB}_150_${IB}_SORT_DLGTAA.dat
export ${PRG}_I3=${EPO_FCURQUOT}
export ${PRG}_I4=${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_160_${IB}_SORT_SEGEST_SOLVENCY_O.dat
export ${PRG}_I5=${EPO_FBOPRSLNK}                                          
#export ${PRG}_I6=${EST_IADPERIFR}
export ${PRG}_I6=${DFILT}/${NJOB}_156_${IB}_SORT_IADPERIFR_O.dat
export ${PRG}_I7=${DFILT}/${NJOB}_161_${IB}_DLDGTAA_UPR_DAC_EOC.dat 
#export ${PRG}_I8=${EST_DLCUMGTAATOT} 
#export ${PRG}_I8=${DFILT}/${NJOB}_152_${IB}_SORT_DLCUMGTAATOT_O.dat
export ${PRG}_I8=${DFILT}/${NJOB}_160_${IB}_SORT_DLCUMGTAATOT_O.dat
...
SORT_I="${DFILT}/${NJOB}_162_${IB}_ESTC1067_DLGTAA.dat 1000 1"
...
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_20_${IB}_SORT_IADPERICASE.dat
export ${PRG}_I2=${DFILT}/${NJOB}_164_${IB}_SORT_IADPERIFCT_O.dat       # ${EST_IADPERIFCT}
export ${PRG}_I3=${DFILT}/${NJOB}_154_${IB}_SORT_IADPERIFCI_O.dat       # ${EST_IADPERIFCI}
export ${PRG}_I4=${DFILT}/${NJOB}_163_${IB}_SORT_DLDGTAA_CLM_O2.dat 		 # CLM ${EST_DLCUMGTAAS}   
export ${PRG}_I5=${DFILT}/${NJOB}_163_${IB}_SORT_DLDGTAA_PRM_O.dat  		 # PRM ${EST_DLGTAAPA}	   
...
SORT_I="${DFILT}/${NJOB}_165_${IB}_ESTC1016_FLOARAT_O2.dat 1000 1"
...
EXECKSH "cp ${DFILT}/${NJOB}_167_${IB}_SORT_FLOARAT_O.dat ${ESF_FUTURE_FLOARAT}"
#---------------------------------------------------------------------------
...
export ${PRG}_I2=${DFILT}/${NJOB}_154_${IB}_SORT_IADPERIFCI_O.dat
#export ${PRG}_I3=${EST_DLCUMGTAATOT} 
export ${PRG}_I3=${DFILT}/${NJOB}_152_${IB}_SORT_DLCUMGTAATOT_O.dat
...
#export ${PRG}_I9=${DFILT}/${NJOB}_162_${IB}_ESTC1067_DLGTAA.dat  # [038][035] Fichieer GT contenant tous les future PREMIUM et CLAIMS 
export ${PRG}_I9=${DFILT}/${NJOB}_163_${IB}_SORT_DLDGTAA_LOSSCOR_O3.dat
...
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_162_${IB}_ESTC1067_DLGTAA.dat 1000 1"
SORT_I2="${DFILT}/${NJOB}_172_${IB}_DLDGTAAPBPAPLOS_REFORMAT.dat 1000 1"
...
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_20_${IB}_SORT_IADPERICASE.dat
export ${PRG}_I2=${DFILT}/${NJOB}_175_${IB}_SORT_DLGTAA_PRMLOSS.dat
export ${PRG}_I3=${EPO_FCURQUOT}
export ${PRG}_I4=${DFILT}/${NJOB}_167_${IB}_SORT_FLOARAT_O.dat
export ${PRG}_I5=${DFILT}/${NJOB}_154_${IB}_SORT_IADPERIFCI_O.dat         #[021]# Recupere le tableau de charges iterees
export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_${PRG}_DLGTAA.dat
export ${PRG}_O2=${DFILT}/${NSTEP}_${IB}_${PRG}_DLGTAA_ANO.log
export ${PRG}_O3=${EST_FUTURE_EBS}			 
EXECPRG 
...
SORT_I2="${DFILT}/${NJOB}_180_${IB}_ESTC1068_DLGTAA.dat 1000 1"
SORT_I3="${DFILT}/${NJOB}_175_${IB}_SORT_DLGTAA_PRMLOSS.dat 1000 1"
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NJOB}_185_${IB}_SORT_DLDGTAA_NEW_O.dat
export ${PRG}_I2=${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_30_${IB}_SORT_DLDGTAA_PREC_O.dat
...
NSTEP=${NJOB}_195
#-----------------------------------------------------------------------------
LIBEL="Sort reversed, by keys ACY/SCOSTR/SCOEND "
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_190_${IB}_ESTC1054_DLDGTAA_E.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_ESTC1054_DLDGTAA_E.dat 1000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS SSD_CF        1:1 -  1:EN
       ,ESB_CF        2:1 -  2:EN
       ,BALSHEY_NF    3:1 -  3:
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_195_${IB}_ESTC1054_DLDGTAA_E.dat 1000 1"
...
/SUMMARIZE TOTAL AMT_M
/DERIVEDFIELD AMT_MC AMT_M COMPRESS
/CONDITION MVTZERO ( AMT_M != 0 AND TRNCOD_CF != "1A430602"  AND TRNCOD_CF != "1A120212" AND TRNCOD_CF != "1A120222")
/OUTFILE ${SORT_O}
/INCLUDE MVTZERO
/REFORMAT
   SSD_CF
...
# EXECKSH "cp ${DFILT}/${NJOB}_185_${IB}_SORT_DLDGTAA_NEW_O.dat ${EST_DLDGTAA_E_TRNCODEBS}"
 EXECKSH "cp ${DFILT}/${NJOB}_200_${IB}_SORT_DLDGTAA_E.dat ${EST_DLDGTAA_E_TRNCODEBS}"
fi
...
export ${PRG}_PRM=${FPRM}
##export ${PRG}_I1=${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_20_${IB}_SORT_IADPERICASE.dat
export ${PRG}_I1=${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_15_${IB}_SORT_IADPERICASE.dat
##export ${PRG}_I1=${DFILT}/${NCHAIN}_ESFD2003A${IDF_CT}_10_${IB}_ESTM1004_IADPERICASE.dat   ##  [070]   
export ${PRG}_I2=${DFILT}/${NJOB}_164_${IB}_SORT_IADPERIFCT_O.dat			 #export ${PRG}_I2=${EST_IADPERIFCT}
export ${PRG}_I3=${DFILT}/${NJOB}_154_${IB}_SORT_IADPERIFCI_O.dat       ##export ${PRG}_I3=${EST_IADPERIFCI}
export ${PRG}_I4=${DFILT}/${NJOB}_163_${IB}_SORT_DLDGTAA_CLM_O2.dat 		 # CLM ${EST_DLCUMGTAAS}   
export ${PRG}_I5=${DFILT}/${NJOB}_163_${IB}_SORT_DLDGTAA_PRM_O.dat  		 # PRM ${EST_DLGTAAPA}	   
export ${PRG}_I6=${DFILP}/empty.dat	    
export ${PRG}_I7=${DFILP}/empty.dat   
