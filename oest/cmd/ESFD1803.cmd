...
#                                 Comptabilisation des ecritures de services I17
# nom du script SHELL           : ESFD1803.cmd
# revision                      : 
# date de creation              : 19/05/2022
# auteur                        : MZM
# references des specifications : SPIRA : 105825 
#-----------------------------------------------------------------------------
# description
...
#[021] 29/07/2022 MZM  	SPIRA : 105825 AE I17 : deplacement LOFACTOR DANS Bouclette (du ESFD2507 a ce nouveau JOB ESFD1803 dedie aux AE I17)
#[022] 29/08/2022 MZM  	SPIRA : 107035 AE I17 : deplacement LOFACTOR DANS Bouclette : Generation des Fichiers I17 INI et Fix sur Doublon
#[023] 10/10/2022 MZM   SPIRA : 107104 RA doubled for new initialised contracts : Update KEY when generated MERGED PERICASE 
#[024] 23/03/2023 MZM   SPIRA : 109257 I17 - reclass on subledgers not eligible to Local : TRI DU FICHIER PERICASE MERGE
#[025] 19/04/2023 MZM   SPIRA : 108587 Mixed retro : AEs are wrong 
#[026] 28/06/2023 MZM   SPIRA : 110102 Regression - AE retro double in RA view : Desactivation I17 "LES ES POST OMEGA IFRS DANS LE BLANCHIMENT DU LEGALE ITALIEN (_IT_)" 
#[027] 30/08/2022 MZM  	SPIRA : 109430 Generation fichier Permanent IRDPericase Merge I17 INI et  STD
#[028] 04/10/2022 MZM  	SPIRA : 110638 Retro AE missing in TL : ANO PRD AE NON GENERE :AJOUT CSUE ASSUME Dans la cle Au step _39
#[029] 04/10/2023 MZM   SPIRA : 110474 PROD6 AEs entries not found in SAP : Force RETUW_NT to 1 when it's not null
#[030] 23/11/2023 JYP/MZM/Florian:Spira:110901 add parameter Y_N for RET OVERRIDE exclude some TC when RAICOM_B=0 
#[031] 09/01/2024 MZM   SPIRA 111096 Issue with retro AE auto generation 
#[032] 08/03/2024 MZM   SPIRA 111009 PRD - Retrocessionaire are missing in RR view 
#[033] 10/04/2024 JYP   SPIRA 110932 parameter A-AE for RET OVERRIDE exclude some TC when RAICOM_B=0  
#[034] 10/04/2024 JYP   SPIRA 110932 parameter A-AE for RET OVERRIDE exclude some TC when RAICOM_B=0 
#[035] 23/09/2024 MZM   SPIRA :112214 Force RETUW_NT to 1 when it's different to 1 (Complement :110474 ) 
#[036] 10/03/2025 MZM   SPIRA :112836 Q25 PRD - Program wrongly adds Retro order 1 when AE booked on Assumed only : "Force RETUW_NT to 1 when ( RETUW_NT != "1" )	AND  (RETCTR_NF != "")"   
#===============================================================================
...
ECHO_LOG "#===> ESF_DLSGTAA_INI................: ${ESF_DLSGTAA_INI}"
...
ECHO_LOG "#===> ESF_IRDPERICASE_STD............: ${ESF_IRDPERICASE_STD}" 
ECHO_LOG "#===> ESF_FI17CLOPER.................: ${ESF_FI17CLOPER}" 
ECHO_LOG "#===> ESF_IRDPERICASE_I17_MERGE......: ${ESF_IRDPERICASE_I17_MERGE}" 
...
NSTEP=${NJOB}_05
# begin sort
#[029] [035][036]  Force RETUW_NT to 1 when it's different to ""   
#-----------------------------------------------------------------------------
...
##[024] Filter PERICASE MEGE On ssd and esb 
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_28_${IB}_SORT_IADVPERICASE_MERGE_O.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_IADVPERICASE_MERGE_O.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS
        SSD_NF                                  1:1 - 1:,
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_29A_${IB}_SORT_IADVPERICASE_MERGE_O.dat 2000 1"
...
##[024] SORTPERICASE MEGE On CTR_NF, END_NT, SEC_NF, UWY_NF, UW_NF 
...
export ${PRG}_I5=${ESF_IADPERICASE_I17_MERGE} #[024]
export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_${PRG}_GTAR100_O.dat
EXECPRG



## DEb [020] DEB Applying LOFACTOR AFTER CESSION

## TRIE du fichier LOFACTOR STD sur RETCTR,RETENT, RETSEC, RTY, RETUW 

NSTEP=${NJOB}_32
# FLORETFACTOR 
#-----------------------------------------------------------------------------
LIBEL="SORT OF FLORETFACTOR STD BY RETCTR,RETENT, RETSEC, RTY, RETUW ..."
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
...
# TRIE du fichier LOFACTOR INI sur RETCTR,RETENT, RETSEC, RTY, RETUW 
...
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_INI_O.dat 2000 1" 
SORT_O2="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_STD_O.dat 2000 1" 
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS 	SSD_CF 							    1:1 - 1:,
					ESB_CF 				          2:1 - 2:,
					BALSHEY_NF 		          3:1 - 3:,
...
NSTEP=${NJOB}_36
# Join and sort of  GTAR100_I17_STD File and FLORETFACTOR_INI by RETCTR,RETENT, RETSEC, RTY, RETUW 
#------------------------------------------------------------------------------
LIBEL="Current GTAR100_I17_STD_O File Sort, Join and Fusion With ESF_FLORETFACTOR_STD ..."
SORT_WDIR=${SORTWORK}
SORT_I="${DFILT}/${NJOB}_34_${IB}_SORT_GTAR100_I17_STD_O.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_STD_FACTOR_O.dat 2000 1"
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS 	SSD_CF 							    1:1 - 1:,
					ESB_CF 				          2:1 - 2:,
					BALSHEY_NF 		          3:1 - 3:,
...
/JOINKEYS RETCTR_NF,
          ...
          CTR_NF, 
					...
					SEC_NF, 
					UWY_NF	
/INFILE ${DFILT}/${NJOB}_32_${IB}_SORT_FLORETFACTOR.dat 2000 1 "~"
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_36_${IB}_SORT_GTAR100_I17_STD_FACTOR_O.dat 2000 1" 
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_STD_FACTOR_O.dat 2000 1" 
INPUT_TEXT $SORT_CMD <<EOF
...
##[028]  ##[031] AJOUT TRN_NT A la Cle 

NSTEP=${NJOB}_39
# SORT UNIQUE of GTAR100_FACTOR_STD 
#------------------------------------------------------------------------------
LIBEL="Current GTAR100 STD File Sort, Join and Fusion UNIQUE..."
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_38_${IB}_SORT_GTAR100_I17_STD_FACTOR_O.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_STD_FACTOR_O.dat 2000 1" 
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS 	SSD_CF 							    1:1 - 1:,
					ESB_CF 				          2:1 - 2:,
...
# [002] APPLYING LORETROFACTOR TO SORT_GTAR100_I17_STD

NSTEP=${NJOB}_40
# Begin C program
#-----------------------------------------------------------------------------
LIBEL="Applying Lofacactor STD to GTAR100_I17_STD..."
PRG=ESTC2308  
FPRM=`CFTMP`
INPUT_TEXT ${FPRM} << EOF
CLODAT_D ${CLODAT_D}
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NJOB}_39_${IB}_SORT_GTAR100_I17_STD_FACTOR_O.dat
export ${PRG}_I2=${EPO_FBOPRSLNK}
export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_${PRG}_GTAR100_I17_STD_FACTOR_O.dat
EXECPRG
...
NSTEP=${NJOB}_36I
# Join and sort of  GTAR100_I17_INI File and FLORETFACTOR_INI by RETCTR,RETENT, RETSEC, RTY, RETUW 
#------------------------------------------------------------------------------
LIBEL="Current GTAR100_I17_INI_O File Sort, Join and Fusion With ESF_FLORETFACTOR_INI ..."
SORT_WDIR=${SORTWORK}
SORT_I="${DFILT}/${NJOB}_34_${IB}_SORT_GTAR100_I17_INI_O.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_INI_FACTOR_O.dat 2000 1"
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS 	SSD_CF 							    1:1 - 1:,
					ESB_CF 				          2:1 - 2:,
					BALSHEY_NF 		          3:1 - 3:,
...
/JOINKEYS RETCTR_NF,
          ...
          CTR_NF, 
					...
					SEC_NF, 
					UWY_NF	
/INFILE ${DFILT}/${NJOB}_32I_${IB}_SORT_FLORETFACTOR_INI.dat 2000 1 "~"
/JOINKEYS RETCTR_NF_F2,
					RETEND_NT_F2,
					RETSEC_NF_F2,
          RTY_NF_F2,
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_36I_${IB}_SORT_GTAR100_I17_INI_FACTOR_O.dat 2000 1" 
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_INI_FACTOR_O.dat 2000 1" 
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS ALL_F1    	            1:1 - 74:       
/KEYS   ALL_F1
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_38I_${IB}_SORT_GTAR100_I17_INI_FACTOR_O.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_INI_FACTOR_O.dat 2000 1" 
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS 	SSD_CF 							    1:1 - 1:,
					ESB_CF 				          2:1 - 2:,
...
# [002] APPLYING LORETROFACTOR TO SORT_GTAR100_I17_INI

NSTEP=${NJOB}_40I
# Begin C program
#-----------------------------------------------------------------------------
LIBEL="Applying Lofacactor INI to GTAR100_I17_INI..."
PRG=ESTC2308  
FPRM=`CFTMP`
INPUT_TEXT ${FPRM} << EOF
CLODAT_D ${CLODAT_D}
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NJOB}_39I_${IB}_SORT_GTAR100_I17_INI_FACTOR_O.dat
export ${PRG}_I2=${EPO_FBOPRSLNK}
export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_${PRG}_GTAR100_I17_INI_FACTOR_O.dat
EXECPRG
...
NSTEP=${NJOB}_42
#-----------------------------------------------------------------------------
LIBEL="MERGE LOFACTOR I17 INI AND I17 STD"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_40_${IB}_ESTC2308_GTAR100_I17_STD_FACTOR_O.dat 2000 1"
SORT_I2="${DFILT}/${NJOB}_40I_${IB}_ESTC2308_GTAR100_I17_INI_FACTOR_O.dat 2000 1"
SORT_O=${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_I17_O.dat
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS TRNCOD_CF        6:1 -  6:,
        CTR_NF           8:1 -  8:,
        END_NT           9:1 -  9:,
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_42_${IB}_SORT_GTAR100_I17_O.dat 500 1"
...
/INFILE ${DFILT}/${NJOB}_43_${IB}_SORT_FACCSUP_RETROAUTO_O.dat 2000 1
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I=${DFILT}/${NJOB}_45_${IB}_MAJ_RETRO_ES_GTAR100_O.dat
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NJOB}_47_${IB}_SORT_GTAR100_O.dat
...
#-----------------------------------------------------------------------------
LIBEL="Sauvegarde des fichiers"
GZIPM_I="${DFILT}/${NJOB}_47_${IB}_SORT_GTAR100_O.dat ${DFILT}/${NJOB}_50_${IB}_ESTC2304_GTART1_O1.dat ${DFILT}/${NJOB}_50_${IB}_ESTC2304_GTART1MAJ_O2.dat ${DFILT}/${NJOB}_50_${IB}_ESTC2304_GTRRT1_O3.dat ${DFILT}/${NJOB}_50_${IB}_ESTC2304_GTRRT1MAJ_O4.dat"
GZIPM

NSTEP=${NJOB}_55
#-----------------------------------------------------------------------------
LIBEL="Temporary file deletion"
RMFIL ${DFILT}/${NJOB}_47_${IB}_SORT_GTAR100_O.dat
...
PRG=RETM0532
export ${PRG}_I1=${DFILT}/${NJOB}_212_${IB}_FPLATXCUM.dat
...
SORT_CMD=`CFTMP`
##SORT_I="${DFILT}/${NJOB}_215_${IB}_RETM0532_DLSGTAR.dat 2000 1"
SORT_I="${DFILT}/${NJOB}_220_${IB}_SORT_DLSGTAR_O.dat 2000 1"
...
# Begin sort
#-----------------------------------------------------------------------------
LIBEL="Generate  DLSGTAR_I17_INI"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${EPO_DLSGTAR} 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLSGTAR_I17_INI_O.dat 2000 1"
#SORT_O="${ESF_DLSGTAR_INI} 2000 1"
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS SSD_CF 1:1 - 1:,
        ESB_CF 2:1 - 2:,
        BALSHEY_NF 3:1 - 3:,
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_241I_${IB}_SORT_DLSGTAR_I17_INI_O.dat 2000 1" 
SORT_O="${ESF_DLSGTAR_INI} 2000 1" 
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS 	SSD_CF 							    1:1 - 1:,
					ESB_CF 				          2:1 - 2:,
...
## [026] Desactivation "italian DLSGTR blanking accumulation" #SORT_I="${DFILT}/${NJOB}_235_${IB}_ESTM7603_IT_DLSGTAR.dat 2000 1"

NSTEP=${NJOB}_245
#------------------------------------------------------------------------------
LIBEL="DLSGTR  accumulation"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_220_${IB}_SORT_DLSGTAR_O.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLSGTR_O.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
...
#[008]
#[019] Suppression des lignes dont Montants RETAMT_M et RETINTAMT_M a zero # ##SORT_I="${DFILT}/${NJOB}_205_${IB}_ESTM7603_DLSGTR.dat 2000 1"
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
##[032]SORT_I="${DFILT}/${NJOB}_245_${IB}_SORT_DLSGTR_O.dat 2000 1"  
...
# Begin sort
#-----------------------------------------------------------------------------
LIBEL="Generate  DLSGTR_I17_INI"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${EPO_DLSGTR} 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLSGTR_I17_INI_O.dat 2000 1"
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS SSD_CF 1:1 - 1:,
        ESB_CF 2:1 - 2:,
        BALSHEY_NF 3:1 - 3:,
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_250I_${IB}_SORT_DLSGTR_I17_INI_O.dat 2000 1" 
#SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLSGTR_I17_INI_O.dat 2000 1"
SORT_O="${ESF_DLSGTR_INI} 2000 1" 
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS 	SSD_CF 							    1:1 - 1:,
					ESB_CF 				          2:1 - 2:,
					BALSHEY_NF 		          3:1 - 3:,
...
#[026] italian DLSGTR blanking accumulation
...
#[009]
#[026] #SORT_I="${DFILT}/${NJOB}_265_${IB}_ESTM7603_IT_DLSGTAA.dat 2000 1"    
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP` 
SORT_I="${DFILT}/${NJOB}_198_${IB}_ESTM7603_DLSGTAA.dat 2000 1"
...
# Begin sort
#-----------------------------------------------------------------------------
LIBEL="Generate  DLSGTAA_I17_INI"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${EPO_DLSGTAA} 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLSGTAA_I17_INI_O.dat 2000 1"
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS SSD_CF 1:1 - 1:,
        ESB_CF 2:1 - 2:,
        BALSHEY_NF 3:1 - 3:,
...
#-----------------------------------------------------------------------------
LIBEL="Current GTAR File Sort, Filter INI..."
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_280I_${IB}_SORT_DLSGTAA_I17_INI_O.dat 2000 1" 
SORT_O="${ESF_DLSGTAA_INI} 2000 1" 
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS 	SSD_CF 							    1:1 - 1:,
					ESB_CF 				          2:1 - 2:,
					BALSHEY_NF 		          3:1 - 3:,
...
NSTEP=${NJOB}_300
#-----------------------------------------------------------------------------
LIBEL="get CSUOE-INI not in irdpericase STD"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${EST_IRDPERICASE0} 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_IRDPERICASE0_INI_O.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS   	
		CTR_NF       3:1 -  3:, 
		END_NT       4:1 -  4:, 
...
/joinkeys
        ...
        UWY_NF,
        UW_NT
/INFILE ${ESF_IRDPERICASE_STD} 2000 1 "~"
/joinkeys
        STD_CTR_NF,
        STD_END_NT,
        STD_SEC_NF,
...
NSTEP=${NJOB}_310
#------------------------------------------------------------------------------
LIBEL="MERGE AND SORT IRDPERICASE INI And STD "
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_300_${IB}_SORT_IRDPERICASE0_INI_O.dat 2000 1"
SORT_I2="${ESF_IRDPERICASE_STD} 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_IRDPERICASE0_MERGE_O.dat 2000 1"
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS   	CTR_NF       3:1 -  3:, 
        		END_NT       4:1 -  4:, 
        		SEC_NF       5:1 -  5:, 
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_310_${IB}_SORT_IRDPERICASE0_MERGE_O.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_IRDPERICASE0_MERGE_O.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS
        SSD_NF                                  1:1 - 1:,
...
NSTEP=${NJOB}_330
#------------------------------------------------------------------------------
LIBEL=" SORT IRDPERICASE MERGE  "
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_320_${IB}_SORT_IRDPERICASE0_MERGE_O.dat 2000 1"
SORT_O="${ESF_IRDPERICASE_I17_MERGE} 2000 1"
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS   	CTR_NF       3:1 -  3:, 
        		END_NT       4:1 -  4:, 
        		SEC_NF       5:1 -  5:, 
