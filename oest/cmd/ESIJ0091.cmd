...
# nom du script SHELL		: ESIJ0091.cmd
...
#
# launched by ESIJ0090.cmd
#-----------------------------------------------------------------------------
# historiques des modifications :
# 11/02/03  J. Ribot step40 et 80  ajout prise en compte colonne retintamt_m
# 05/04/04  M.DJELLOULI : Appel en Asynchrone des Demandes d'Inventaire
#           On conditionne les STEPS 123 à 127
# 30/06/04  M.DJELLOULI : On ne conditionne pas le STEP 125 (Swith à INFOMEGA)
#           car il est Utilisé pour la mise à jour de TACCSUP en STEP 130
# 26/04/05  M.DJELLOULI : SPOT 5084 - MOD03
#                                    Ajout de la Zone SPEENTTYP_CF de TACCSUP
#                                    STEP 40 : Ajout ZONE SPEENTTYP_CF (Position 54)
#                                    STEP 50 : Remplacer ESTC2303 par ESTC2333
#                                    STEP 70 : Remplacer ESTC2304 par ESTC2334
#                                    STEP 80 : Ajout ZONE SPEENTTYP_CF (Position 52)
#                                    STEP 85 : Ajout ZONE SPEENTTYP_CF (Dernière Position ap.  LSTUPDUSR_CF)
...
# 24/06/05  M.DJELLOULI : SPOT 5084 - MOD03
#                                    Ajout de la Zone SPEENTNAT_CT de TACCSUP
#                                    STEP 40 : Ajout ZONE SPEENTNAT_CT (Position 55)
#                                    STEP 80 : Ajout ZONE SPEENTNAT_CT (Position 53)
#                                    STEP 85 : Ajout ZONE SPEENTNAT_CT (Dernière Position ap.  LSTUPDUSR_CF)
#                                    STEP 60 : Remplacer ESTC2303 par ESTC2333
#                                    STEP 65 : Remplacer ESTC2303 par ESTC2333
#                                    STEP 80 : Remplacer ESTC2304 par ESTC2334
#                                    STEP 83 : Remplacer ESTC2304 par ESTC2334
#[004] 26/04/2011  Roger Cassis     :spot:21408 - Si pas de fichiers provenant du ESID2500, on fait un touch
#[005] 17/07/2012 Florent :spot:23390 Solvency II, ajout gestion d'un record plus grand à cause de commentaires sur les sort venant de TACCSUP
#[006] 02/12/2013 Florent      :spot:25427 - maj partition
#[007] 20/02/2015 R. cassis :spot:28328 - Add 2 columns EVT_NF and REVT_NF to TACCSUP
#[008] 02/02/2016 -=Dch=-  	 :spot:29162 Impact Retro P&C -> bcp IADVPERICASE ajout pour ESTC2333
#[009] 25/10/2017 R. cassis :spira:61508 Ajout option A dans prog ESTC2333 (A=autre/L=Local)
#[010] 23/09/2019 R. Vieville :spira:81337 Remove step 120 and 130 Optimisation de la chaine ESIJ0090
#[011] 22/11/2021 R. Cassis   :spira:100493 Remplacement PERTYP_CT par PARM_PERTYP_CT
#===============================================================================
...
BCP_QRY="exec BEST..PiESTACCSUP_01 '${CRE_D}'"
BCP
...
EOF
   ...
   # Environmental variables point to current Cessions & Placements Files
	...
	#[004]
	if [ ! -f ${DFILP}/${PCH}ESID2500_FCES_*.dat ]
	then
		...
		export ESTV_FCES_SER=`ls ${DFILP}/${PCH}ESID2500_FCES_*.dat  2> /dev/null | sort -u | sed -n -e $,1p`  # modif OG 17/05/2000
	fi
	if [ ! -f ${DFILP}/${PCH}ESID2500_FPLC_*.dat ]
	then
		...
		export ESTV_FPLC_SER=`ls ${DFILP}/${PCH}ESID2500_FPLC_*.dat  2> /dev/null | sort -u | sed -n -e $,1p`
	fi
