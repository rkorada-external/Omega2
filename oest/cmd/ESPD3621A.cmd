...
# nom du script SHELL           : ESPD3621.cmd
...
#[037] 13/05/2020 Charles Socie SPIRA : 83206 REQ 11.7 - For contract incepting before closing date please adapt the pattern used for discounting change input ESTC1056A 
#[038] 13/07/2020 R. Cassis :spira: 84474  Manque la colonne SEG_NF dans la cle de tri step269
#[039] 31/08/2020 Charles Socie : SPIRA 88975  IFRS17 add Retropericase to ESTC1056A
#===============================================================================
...
then
  ...
  #[037] add Context_ct, Closing_date and I3  
...
# ${DFILT}/${NJOB}_265_${IB}_ESTC2315A_DLDSIIGTAR.dat        : les lignes retro hors CSF et hors RMNTP, topées R ou RI pour celles ayant participé aux echanges internes
