...
#                                 Edition de la liste des anomalies sur segment
# nom du script SHELL		: ESEJ0241.cmd
...
#
# job launched by ESEJ0240.cmd or asynchron
#-----------------------------------------------------------------------------
...
PRN_NAME=${PRTID}
PRN_I=${DFILT}/${NJOB}_05_${IB}_ESTR0350_O.dat
PRN_FMT="estr0350"	#fichier .sp .sjp
PRN
