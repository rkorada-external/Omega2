...
#                                 Inventaire dommages
# nom du script SHELL           : ESPD2000.cmd
...
#[003] 13/02/2013 -=PHP=-      :spot:24836  Corrections solvency 2
#===============================================================================
#set -x
...
NJOB="ESPD2002${TYPEINV}"
${DCMD}/ESID2002.cmd ${CRE_D} ${CONSOYEA} ${CLOTYP_CT} ${INVCONSO_D} ${SSDs0} ${SSDVRS_LL} ${LSTCLODAT_LL} ${SSDDEL_LL} EBS ${TYPEINV} 2>&1 | ${TEE}

# Launch applicative job ESID2001
NJOB="ESPD2003${TYPEINV}"
${DCMD}/ESID2003.cmd ${TYPEINV} ${INVCONSO_D} 2>&1 | ${TEE}
