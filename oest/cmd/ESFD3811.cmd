...
#[003] 24/10/2023 : SPIRA 110247: JYP: bugfix/revert, update gaap_code again for CANCELLATION when IFRS4
#[004] 06/11/2023 : SPIRA 110247: JYP: bugfix/revert, update gaap_code again for CANCELLATION when LOCAL
#===============================================================================
...
/KEYS   SSD_CF,
        ESB_CF,
        DETTRS_CF
/CONDITION POST_CUR (FLAG_OA != "A" OR "${NORME_CF}" = "I4I"  OR "${NORME_CF}" = "" ) AND GAAPCOD_NF = "" 
/OUTFILE ${SORT_O}
/INCLUDE POST_CUR
/OUTFILE ${SORT_O2}
/OMIT POST_CUR
