...
# nom du script SHELL           : ESTS0068.cmd
# revision                      : $Revision:   1.0  $
# date de creation              : 24\02\2025
# auteur                        : David DA SILVA TEIXEIRA
#-----------------------------------------------------------------------------
# description : Sort contract rate index extended file by CSUOE Assum for retro P
#-----------------------------------------------------------------------------
#=============================================================================
...
#-----------------------------------------------------------------------------
NSTEP=${NJOB}_$1-1
LIBEL="Sort P Retro contract rate index extended by CSUOE Assum"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
...
#-----------------------------------------------------------------------------
NSTEP=${NJOB}_$1-2
LIBEL="Sort NP Retro contract rate index extended by CSUOE Retro"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${INPUT}.dat 2000 1"
