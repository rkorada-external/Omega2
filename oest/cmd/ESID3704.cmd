...
# nom du script SHELL           : ESPD3704.cmd
# revision                      : 
...
#
# Output files
#       EPO_VENTNPSII_TRIMCURSO      DFILP
#       EPO_VENTNPSII_TRIMCURCO      DFILP
...
if [ "${TYPEINV}" != "INV" ]
then
    EPO_FTRSLNK=${EPO_FTRSLNK8} # Fichier de correspondance commun EBS et IFRS genere par la Proc Stockee PsTRSLNK_03 de generation de postes comptable 720 
  if [ "${TYPEINV}" = "POS" ]
  then
    EPO_DLDSIIGTAR=${EPO_DLDSIIGTARSO}
    EPO_VENTNPSII_TRIMCUR=${EPO_VENTNPSII_TRIMCURSO}
    TYPEPO=SO
  else
    EPO_DLDSIIGTAR=${EPO_DLDSIIGTARCO}
    EPO_VENTNPSII_TRIMCUR=${EPO_VENTNPSII_TRIMCURCO}
    TYPEPO=CO
  fi
...
NSTEP=${NJOB}_00
#Last version of ESPD3704 files deletion
#-----------------------------------------------------------------
RMFIL "  `dirname ${EPO_DLDSIIGTAR}`/${PCH}ESID3704_DLDSIIGTAR*.dat"
...
gzip -c ${EPO_DLDSIIGTAR} > ${DFILT}/${NJOB}_DLDSIIGTAR_avant_${TYPEPO}.dat.gz
...
EOF
    ...
    export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_${PRG}_SORT_DLDSIIGTAR1_O.dat
    export ${PRG}_O2=${DFILT}/${NSTEP}_${IB}_${PRG}_SORT_DLDSIIGTAR1_O.ano
    export ${PRG}_O3=${EPO_VENTNPSII_TRIMCUR}
    EXECPRG
else
    NSTEP=${NJOB}_80
    # Begin execksh
    ...
    EXECKSH_MODE=P
    EXECKSH "mv ${DFILT}/${NJOB}_40_${IB}_SORT_SUM_DLDSIIGTAR.dat ${DFILT}/${NJOB}_70_${IB}_ESTC8805_SORT_DLDSIIGTAR1_O.dat"
    EXECKSH "touch ${EPO_VENTNPSII_TRIMCUR}"
fi
...
gzip -c ${DFILT}/${NJOB}_70_${IB}_ESTC8805_SORT_DLDSIIGTAR1_O.dat     >  ${DFILT}/${NJOB}_70_ESTC8805_SORT_DLDSIIGTAR1_O.dat.gz
...
gzip -c ${EPO_VENTNPSII_TRIMCUR} > ${DARCH}/${NJOB}_VENTNPSII_TRIMCUR_O_${TYPEPO}.dat.gz
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_70_${IB}_ESTC8805_SORT_DLDSIIGTAR1_O.dat 1000 1"
SORT_I2="${EPO_VENTNPSII_TRIMCUR} 1000 1"
...
gzip -c ${DFILT}/${NJOB}_70_${IB}_ESTC8805_SORT_DLDSIIGTAR1_O.dat > ${DFILT}/${NJOB}_ESTC8805_SORT_DLDSIIGTAR1_O_${TYPEPO}.dat.gz
