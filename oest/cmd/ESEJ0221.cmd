...
#                                 Edition de la liste des exercices d'un
#                                 segment
# nom du script SHELL		: ESEJ0221.cmd
...
#
# job launched by ESEJ0220.cmd or asynchron
#-----------------------------------------------------------------------------
...
PRN_NAME=${PRTID}
PRN_I=${DFILT}/${NJOB}_05_${IB}_ESTR0330_O.dat
PRN_FMT="estr0330"	#fichier .sp .sjp
PRN
