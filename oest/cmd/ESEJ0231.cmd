...
#                                 Edition de la liste des anomalies sur contrat
# nom du script SHELL		: ESEJ0231.cmd
...
#
# job launched by ESEJ0230.cmd or asynchron
#-----------------------------------------------------------------------------
...
PRN_NAME=${PRTID}
PRN_I=${DFILT}/${NJOB}_05_${IB}_ESTR0340_O.dat
PRN_FMT="estr0340"	#fichier .sp .sjp
PRN
