...
RMFIL "
 ...
 # [003]`dirname ${EST_FT}`/${NCHAIN}_FT*.dat*
 # [003]`dirname ${EST_DLCUMGTAAS}`/${NCHAIN}_DLCUMGTAAS*.dat*
...
SORT_O2="${DFILT}/${NCHAIN}_ESID2001_30_${IB}_ESTM1002_IADPERICASE_TERM_O.dat" 
...
/FIELDS 
		...
		all_cols		 				1:1  - 206:
/CONDITION COND_PERM  ( ( PER_UWORG_CF != "253" AND PER_UWORG_CF != "255" AND PER_UWORG_CF != "13") OR
...
/CONDITION COND_PERM_TERM  ( ( PER_UWORG_CF != "253" AND PER_UWORG_CF != "255" AND PER_UWORG_CF != "13") OR
					  ...
					  PER_SECACCSTS_CT = "9"
/CONDITION COND_UW_RI  ( ( PER_UWORG_CF != "253" AND PER_UWORG_CF != "255" AND PER_UWORG_CF != "13") OR
						( PER_UWORG_CF = "253" AND PER_CED_NF = "38466" ) 
					  ) AND 
...
/joinkeys 
	...
	PERPRMD_UWY_NF			,
	PERPRMD_UW_NT 			
/INFILE ${DFILT}/${NCHAIN}_ESID2001_80_${IB}_ESTC1005_IADPERICASE_O2.dat 1000 1 "~"
/joinkeys 
	PER_CTR_NF			,	
	PER_END_NT			,
	PER_SEC_NF			,
