...
# nom du script SHELL           : ESLJ0091.cmd
# revision                      :
...
#-----------------------------------------------------------------------------
# description
#   Extrait les ecritures de service Local de BEST..TACCSUP (cpeentnat_ct 7 et 8 
#   et met a jour les informations retrocession (cession,placement) en rechargeant dans BEST..TACCSUP
#
# Input files
#       ESL_FCES
#       ESL_FCURCVSN
...
#[002] 04/12/2025 Sir JYP :US6343: optimisation , perf issue on LOCAL 
#===============================================================================
...
ECHO_LOG "#===> LOCPSTOMGEN_D.........: ${LOCPSTOMGEN_D}"
...
BCP_QRY="exec BEST..PiESTACCSUP_04L"
BCP
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_10_${IB}_BCP_FACCSUP_O.dat 1000 1"
...
/REFORMAT SSD_CF, ESB_CF, BALSHEY_NF, BALSHRMTH_NF, BALSHRDAY_NF, TRNCOD_CF, DBLTRNCOD_CF, 
          ...
          CLM_NF, CUR_CF, AMT_M, CED_NF, BRK_NF, PAY_NF, KEY_NF, 
          RETCTR_NF, RETEND_NT, RETSEC_NF, RTY_NF, RETUW_NT, RETOCCYEA_NF, 
          RETACY_NF, RETSCOSTRMTH_NF, RETSCOENDMTH_NF, RCL_NF, RETCUR_CF, RETAMT_M, PLC_NT, RTO_NF, 
          INT_NF, RETPAY_NF, RETKEY_CF, ZERO, SEPA, ENTPERY_NF, ENTPERMTH_NF, VALPERY_NF, VALPERMTH_NF, 
          TRN_NT, ACCTYP_NF, COMMAC_LL, SPEENTTYP_CF, SPEENTNAT_CT, EVT_NF, REVT_NF
exit
EOF
SORT

##----------------
gzip -c ${DFILT}/${NJOB}_10_${IB}_BCP_FACCSUP_O.dat > ${DFILT}/${NJOB}_10_BCP_FACCSUP_O.dat.gz
##----------------
...
RMFIL ${DFILT}/${NJOB}_10_${IB}_BCP_FACCSUP_O.dat
...
##----------------
gzip -c ${DFILT}/${NJOB}_20_${IB}_SORT_GTAA_O.dat > ${DFILT}/${NJOB}_20_SORT_GTAA_O.dat.gz
##----------------
...
##----------------
gzip -c ${DFILT}/${NJOB}_40_${IB}_ESTC2333_GTAR100_O1.dat > ${DFILT}/${NJOB}_40_ESTC2333_GTAR100_O1.dat.gz
##----------------
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_40_${IB}_ESTC2333_GTAR100_O1.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTAR100_O.dat 1000 1" #[01]
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS TRNCOD_CF 6:1 - 6:, CTR_NF 8:1 - 8:, END_NT 9:1 - 9:, SEC_NF 10:1 - 10:, UWY_NF 11:1 - 11:, UW_NT 12:1 - 12:, 
        OCCYEA_NF 13:1 - 13:, ACY_NF 14:1 - 14:, SCOSTRMTH_NF 15:1 - 15:, SCOENDMTH_NF 16:1 - 16:, CLM_NF 17:1 - 17:, 
        CUR_CF 18:1 - 18:, RETCTR_NF 24:1 - 24:, RETEND_NT 25:1 - 25:, RETSEC_NF 26:1 - 26:, RTY_NF 27:1 - 27:, RETUW_NT 28:1 - 28:, 
        RETOCCYEA_NF 29:1 - 29:, RETACY_NF 30:1 - 30:, RETSCOSTRMTH_NF 31:1 - 31:, RETSCOENDMTH_NF 32:1 - 32:, RCL_NF 33:1 - 33:
/KEYS RETCTR_NF, RETEND_NT, RETSEC_NF, RTY_NF, RETUW_NT, TRNCOD_CF, CUR_CF, RETOCCYEA_NF, RCL_NF, RETACY_NF, RETSCOSTRMTH_NF, RETSCOENDMTH_NF, 
      CTR_NF, END_NT, SEC_NF, UWY_NF, UW_NT , OCCYEA_NF, CLM_NF, ACY_NF, SCOSTRMTH_NF, SCOENDMTH_NF
exit
EOF
SORT
...
#------------------------------------------------------------------------------
LIBEL="Delete of temporary file"
RMFIL ${DFILT}/${NJOB}_40_${IB}_ESTC2333_GTAR100_O1.dat
...
##----------------
gzip -c ${DFILT}/${NJOB}_60_${IB}_SORT_GTAR100_O.dat > ${DFILT}/${NJOB}_60_SORT_GTAR100_O.dat.gz
gzip -c ${DFILT}/${NJOB}_70_${IB}_ESTC2334_GTAR_O1.dat > ${DFILT}/${NJOB}_70_ESTC2334_GTAR_O1.dat.gz
gzip -c ${DFILT}/${NJOB}_70_${IB}_ESTC2334_GTARMAJ_O2.dat > ${DFILT}/${NJOB}_70_ESTC2334_GTARMAJ_O2.dat.gz
##----------------
...
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_FACCSUP_O.dat 1000 1" #[01]
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS SSD_CF 1:1 - 1:, ESB_CF 2:1 - 2:, TRNCOD_CF 6:1 - 6:, DBLTRNCOD_CF 7:1 - 7:, 
        CTR_NF 8:1 - 8:, END_NT 9:1 - 9:, SEC_NF 10:1 - 10:, UWY_NF 11:1 - 11:, UW_NT 12:1 - 12:, 
        OCCYEA_NF 13:1 - 13:, ACY_NF 14:1 - 14:, SCOSTRMTH_NF 15:1 - 15:, SCOENDMTH_NF 16:1 - 16:, 
        CLM_NF 17:1 - 17:, CUR_CF 18:1 - 18:, AMT_M 19:1 - 19:, CED_NF 20:1 - 20:, BRK_NF 21:1 - 21:, 
        PAY_NF 22:1 - 22:, KEY_NF 23:1 - 23:, 
        RETCTR_NF 24:1 - 24:, RETEND_NT 25:1 - 25:, RETSEC_NF 26:1 - 26:, RTY_NF 27:1 - 27:, RETUW_NT 28:1 - 28:, 
        RETOCCYEA_NF 29:1 - 29:, RETACY_NF 30:1 - 30:, RETSCOSTRMTH_NF 31:1 - 31:, RETSCOENDMTH_NF 32:1 - 32:, 
        RCL_NF 33:1 - 33:, RETCUR_CF 34:1 - 34:, RETAMT_M 35:1 - 35:, PLC_NT 36:1 - 36:, RTO_NF 37:1 - 37:, 
        INT_NF 38:1 - 38:, RETPAY_NF 39:1 - 39:, RETKEY_CF 40:1 - 40:, RETINTAMT_M 41:1 - 41:, 
        ENTPERY_NF 42:1 - 42:, ENTPERMTH_NF 43:1 - 43:, VALPERY_NF 44:1 - 44:, VALPERMTH_NF 45:1 - 45:, TRN_NT 46:1 - 46:, ACCTYP_NF 47:1 - 47:, 
        BALSHEY_NF 48:1 - 48:, BALSHRMTH_NF 49:1 - 49:, BALSHRDAY_NF 50:1 - 50:, COMMAC_LL 51:1 - 51:, 
        SPEENTTYP_CF 52:1 - 52:, SPEENTNAT_CT 53:1 - 53:, EVT_NF 54:1 - 54:, REVT_NF 55:1 - 55:
/COPY
...
/OUTFILE ${SORT_O}
/REFORMAT TYP_NF, SEPA, SSD_CF, ESB_CF, ENTPERY_NF, ENTPERMTH_NF, BALSHEY_NF, BALSHRMTH_NF, BALSHRDAY_NF, VALPERY_NF, VALPERMTH_NF, 
          TRNCOD_CF, DBLTRNCOD_CF, ZERO, SEPA, CTR_NF, END_NT, SEC_NF, UWY_NF, UW_NT, OCCYEA_NF, ACY_NF, SCOSTRMTH_NF, SCOENDMTH_NF, 
          CLM_NF, CUR_CF, AMT_M, CED_NF, BRK_NF, PAY_NF, KEY_NF, RETCTR_NF, RETEND_NT, RETSEC_NF, RTY_NF, RETUW_NT, 
          PLC_NT, RETOCCYEA_NF, RETACY_NF, RETSCOSTRMTH_NF, RETSCOENDMTH_NF, RCL_NF, RETCUR_CF, RETAMT_M, 
          RTO_NF, INT_NF, RETPAY_NF, RETKEY_CF, TRN_NT, COMMAC_LL, CRE_D, SEPA, VIDE, SEPA, CRE_D, SEPA, LSTUPDUSR_CF, SEPA, 
          SPEENTTYP_CF, SPEENTNAT_CT, EVT_NF, REVT_NF
exit
EOF
SORT

gzip -c ${DFILT}/${NJOB}_85_${IB}_SORT_FACCSUP_O.dat > ${DFILT}/${NJOB}_85_SORT_FACCSUP_O.dat.gz
...
#-----------------------------------------------------------------------------
LIBEL="Adding an identity column to the Acceptance TL"
PRG=ESTC8800
FPRM=`CFTMP`
INPUT_TEXT $FPRM << EOF
TRN_NT ${TRNMAX_NT}
...
# Begin bcp
#------------------------------------------------------------------------------
LIBEL="Selection of service writings from TACCSUP to ${ESL_EPOSOCLO_NEW}"
BCP_WAY="OUT"
BCP_VER="+"
BCP_O=${ESL_EPOSOCLO_NEW}
BCP_QRY="exec BEST..PiESTACCSUP_05L"
BCP

#---------------------------------------------------------------------------
gzip -c ${ESL_EPOSOCLO_NEW} > ${DFILT}/${NCHAIN}_${IB}_EST_ESLJ0090_EPOSOCLO_NEW.dat.gz
#---------------------------------------------------------------------------
