...
#[036] 05/04/2024 MZM : SPIRA 111190   20.1 - I17 - Add the LC reclass to the IO auto generation - Update   
#[037] 05/04/2024 MZM : SPIRA 111210   20.1 - I17 - Gaps between RA & RR on Rec disc cancel 
#[038] 22/04/2024 MZM : SPIRA 111156   20.1 - I17 - Opening 24 vs Closing 23 - Cancellation done on Reclass transactions while should not 
#[039] 10/05/2024 MZM : SPIRA 111009   20.1 - I17 - FIX SUR SIGNE DES RECLASS 
#[040] 22/05/2024 MZM : SPIRA 111190   20.1 - I17 - Add the LC reclass to the IO auto generation - Copy
#===============================================================================
...
NSTEP=${NJOB}_75
#------------------------------------------------------------------------------------
LIBEL="Excluse Life ${ESF_FTECLEDR}"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
...
## /INFILE ${DFILT}/${NCHAIN}_ESFD4033_1_${NORME_CF}_11_${IB}_GAAPMAP_IFRS17.dat 2000 1 "~" 
...
#[040] Correction sur RETRO ( TRNCOD01_CF = "1" )
...
##[036]  Generation des MOUVEMENTS LC AI IFRS17   FIN ###
...
###[033] AWK_I=${DFILT}/${NJOB}_75H_${IB}_${EST_BASE}_IFRS17_NOLIFE_RSLNK_O_AI.dat
...
#[039] Ne plus vider les colonnes GAAPCOD_NT, I17PRDCOD_CT ; Vider GT_ANNUL_OPNG que si differe de "A", "O"

NSTEP=${NJOB}_80
#------------------------------------------------------------------------------------
LIBEL="Apply transformation to ${ESF_FTECLEDR}"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
...
/OUTFILE ${SORT_O} overwrite
/REFORMAT
	leftside : S_HEAD,BALSHEY_NF_NEW,BALSHRMTH_NF_NEW,BALSHRDAY_NF_NEW, rightside : TARGDETTRS_CF, SEPARATEUR,leftside : S_MID1, CRE_NEW , leftside : S_MID2 , TRN_NT_NEW, ORICOD_NEW, leftside : S_TAIL1, GAAPCOD_NT_NEW, I17PRDCOD_CT_NEW, leftside : S_TAIL2,  rightside : MAPTYP_CT,  rightside : ORIACMTRS_NT,  rightside : ORIDETTRS_CF,  rightside : TARGACMTRS_NT,  rightside : TARGDETTRS_CF
exit
EOF
SORT
...
/FIELDS
        ...
        RTY_NF           27:1 - 27:,
        RETUW_NT         28:1 - 28:,  
        ORIACMTRS_NT    73:1 - 73:,
        ORIDETTRS_CF    74:1 - 74:,
        TARGACMTRS_NT   75:1 - 75:,
        TARGDETTRS_CF   76:1 - 76:,                                           
        ALL_COLS_F1      1:1 - 77:             
/KEYS       
				CTR_NF          
				,END_NF          
...
/FIELDS
        ...
        RTY_NF_F2           27:1 - 27:,
        RETUW_NT_F2         28:1 - 28:,  
        ORIACMTRS_NT    71:1 - 71:,

        TARGACMTRS_NT_F2   75:1 - 75:,
        TARGDETTRS_CF_F2   77:1 - 77:            
/KEYS       
				CTR_NF_F2    
				,END_NF_F2    
				,SEC_NF_F2    
...
NSTEP=${NJOB}_81
#----------------------------------------------------------------------------------
LIBEL="Apply transformation to ${ESF_FTECLEDR} Filter LC AI"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
...
/FIELDS
        ...
        TARGACMTRS_NT_F2   74:1 - 74:,
        TARGDETTRS_CF_F2   76:1 - 76:        
/JOINKEYS       
				CTR_NF          
				,END_NF          
				,SEC_NF          
...
#[040] Fix sur le signe incorrect de vertains RECLASS (colonne 74)
