#!/bin/ksh
#=============================================================================
# nom de lapplication		: SEGMENTATION - BATCH - MONTHLY WEEKLY DAILY
# nom du script SHELL		: ESEM2020.cmd
...
# Launch the monthly, weekly and daily segmentation process
#-----------------------------------------------------------------------------
...
set `GETPRM $DPRM/ESEM2020.prm`
export RUN_DATE=$1
export PRDSIT_CF="$HOST_PRDSIT"
export SEG_FREQ=1,2,3
export CON_FACTOR=$2
