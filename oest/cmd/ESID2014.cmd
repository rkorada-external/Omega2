...
EXECKSH_MODE=P
RMFIL ${EST_IADPERIFR}.gz
RMFIL ${EST_DLCUMGTAAS}.gz
RMFIL ${EST_FTTR_PRM}.gz
RMFIL ${EST_IADPERIFCI}.gz
RMFIL ${EST_CTRULT02}.gz
RMFIL ${EST_FCTREST}.gz
#
EXECKSH "gzip ${EST_IADPERIFR}"
EXECKSH "gzip ${EST_DLCUMGTAAS}"
EXECKSH "gzip ${EST_FTTR_PRM}"
EXECKSH "gzip ${EST_IADPERIFCI}"
EXECKSH "gzip ${EST_CTRULT02}"
EXECKSH "gzip ${EST_FCTREST}"
