...
#then
#	#ESID4000
#	EST_DLDVGTR=${EST_DLDVGTR}
#	EST_DLEIGTAA=${EST_DLEIGTAA}
#	EST_FPLC=${EST_FPLC}
#	EST_FSSDACTR=${EST_FSSDACTR}
#	EST_FDETTRS=${EST_FDETTRS}
#	EST_IADVPERICASE=${EST_IADVPERICASE}
#	EST_DLRIGTAA=${EST_DLRIGTAA}
#else
#	if [ "${TYPEINV}" = "POS" ]
#	then
#		if [ "${NORME}" = "EBS" ]
...
gzip -c ${EST_DLEIGTAA}   > ${DFILT}/${NSTEP}_${IB}_DLEIGTAA.dat.gz
gzip -c ${EST_DLRIGTAA}   > ${DFILT}/${NSTEP}_${IB}_DLRIGTAA.dat.gz
