...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NCHAIN}_TLIFPRNO_LIFSTAREP_20021231.dat 1000 "
SORT_I2="${DFILT}/${NCHAIN}_TLIFPRNO_LIFSTAREP_20031231.dat 1000 "
SORT_I3="${DFILT}/${NCHAIN}_TLIFPRNO_LIFSTAREP_20040331.dat 1000 "
SORT_I4="${DFILT}/${NCHAIN}_TLIFPRNO_LIFSTAREP_20040630.dat 1000 "
SORT_I5="${DFILT}/${NCHAIN}_TLIFPRNO_LIFSTAREP_20040930.dat 1000 "
SORT_I6="${DFILT}/${NCHAIN}_TLIFPRNO_LIFSTAREP_20041231.dat 1000 "
SORT_I7="${DFILT}/${NCHAIN}_TLIFPRNO_LIFSTAREP_20050331.dat 1000 "
SORT_O=${DFILT}/${NSTEP}_${IB}_SORT_LIFSTAREP_O1.dat
...
NSTEP=${NJOB}_07
# delete TLIFSTAREP old data"
#--------------------------------------------------------------------------
LIBEL="delete TLIFSTAREP old data"
ISQL_BASE="BSTA"
ISQL_QRY='DELETE FROM BSTA..TLIFSTAREP WHERE CLODAT_D < "20050430"'
ISQL

NSTEP=${NJOB}_10
# Begin bcp
#------------------------------------------------------------------------------
LIBEL="Loading TLIFSTAREP table"
BCP_WAY="IN"
BCP_VER=""
BCP_I=${DFILT}/${NJOB}_10_${IB}_SORT_LIFSTAREP_O1.dat
BCP_TABLE="BSTA..TLIFSTAREP"
BCP
