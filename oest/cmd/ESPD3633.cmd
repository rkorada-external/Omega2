...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_200_${IB}_SORT_DLAGTAR_O.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLAGTAR_RATE.dat 1000 1 "
INPUT_TEXT ${SORT_CMD} << EOF
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_200A_${IB}_SORT_DLAGTAR_RATE.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLAGTAR_RATE_RETRATE.dat 1000 1 "
INPUT_TEXT ${SORT_CMD} << EOF
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_200B_${IB}_SORT_DLAGTAR_RATE_RETRATE.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLAGTAR_RATE_RETRATE_EBS.dat 1000 1 "
INPUT_TEXT ${SORT_CMD} << EOF
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_200C_${IB}_SORT_DLAGTAR_RATE_RETRATE_EBS.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLAGTAR_RATE_RETRATE_EBS_FBOPRSLNK.dat 1000 1 "
INPUT_TEXT ${SORT_CMD} << EOF
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_200D_${IB}_SORT_DLAGTAR_RATE_RETRATE_EBS_FBOPRSLNK.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLAGTAR_RATE_RETRATE_EBS_FBOPRSLNK.dat 1000 1 "
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS TRNCOD_CF         6:1 -  6:,
        CTR_NF            8:1 -  8:,
...
export ${PRG}_I2=${DFILT}/${NJOB}_200E_${IB}_SORT_DLAGTAR_RATE_RETRATE_EBS_FBOPRSLNK.dat
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_220_${IB}_ESTC1051B_DLAGTAR.dat 1000 1"
SORT_I2="${DFILT}/${NCHAIN}_ESPD3631${TYPEINV}_20_${IB}_SORT_DLAGTAR_O.dat 1000 1"
...
#-----------------------------------------------------------------------------
LIBEL="Double entry transaction code addition DLAGTAR in progress ..."
PRG=ESTM7603
