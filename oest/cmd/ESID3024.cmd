...
# [012] 09/12/2025 JYP  INC0462808 : PROD booking EU KO, increase limits to avoid syncsort failure
#===============================================================================
#set -x
...
EXECPRG
    ...
    mv $DFILT/${NJOB}_190_1_${IB}_RESERVE_02${IT}.dat ${DFILT}/${NSTEP}_${IB}_RESERVE_03${IT}.dat
fi
...
then
  ...
  mv ${EST_LIFESTNOACC} ${DFILT}/${NJOB}_200_${IB}_ESTC2044_ALL_LIFEST_NOACC_O1${IT}.dat
fi
