...
NJOB="ESFD2651A_${BOUCLE}"
${DCMD}/ESFD2651A.cmd ${PARM_RETTHRESHOLD_R} ${PARM_CRE_D} ${PARM_DBCLO_D} ${TYPEINV} ${CLOSING_MODE} 2>&1 | ${TEE}


#[08]
	# Merge  du ESFD3780 et du ESFD3890 ===>  DLDGTAASII : # A CREER ESID2508.cmd
 if [ "${IDF_CT}" = "I17G_LCC_RPO_STD_OPT" ] || [ "${IDF_CT}" = "I17L_LCC_RPO_STD" ] || [ "${IDF_CT}" = "I17P_LCC_RPO_STD" ] || [ "${IDF_CT}" = "I17S_LCC_RPO_STD" ]
 then	
	NJOB="ESFD2508"
...
while [[ ${BOUCLE} -le ${BOUCLES} ]]; do
	...
	NJOB="ESFD2663_${BOUCLE}"
	${DCMD}/ESFD2663.cmd ${PARM_CONSOYEA} ${PARM_CONSOMTH} ${PARM_INVCONSO_D} ${PARM_CRE_D} ${TYPEINV} ${CLOSING_MODE} ${BOUCLE} 2>&1 | ${TEE}
	...
	NJOB="ESFD2651_${BOUCLE}"
	${DCMD}/ESFD2651.cmd ${PARM_RETTHRESHOLD_R} ${PARM_CRE_D} ${PARM_DBCLO_D} ${TYPEINV} ${CLOSING_MODE} ${BOUCLE} 2>&1 | ${TEE} 
