...
#[34] 07/05/2020 Charles Socie : SPIRA 83206  IFRS17 REQ11.7 For contract incepting before closing date please adapt the pattern used for discounting add pericase to ESTC1056A
#[35] 28/07/2020 JYP SPIRA 87660 : mapping for ICR at Inception
#[36] 31/08/2020 Charles Socie : SPIRA 88975  IFRS17 add Retropericase to ESTC1056A
#[37] 27/01/2021 Charles Socie : SPIRA 92917  IFRS 17 Transition Init: Adapt RMNTP
#===============================================================================
...
NSTEP=${NJOB}_50T
  #-----------------------------------------------------------------------------
  LIBEL="CSF CALCULATION Calcul du CashFlow (Transition)"
  PRG=ESTC1056A
  FPRM=`CFTMP`
  INPUT_TEXT ${FPRM} << EOF
TRIM_NF ${TRIM_NF}
...
EOF
  ...
  export ${PRG}_O1=${DFILT}/${NJOB}_50_${IB}_ESTC1056A_CASHFLOW.dat
  export ${PRG}_O2=${DFILT}/${NJOB}_50_${IB}_${PRG}_FSEGPATTERN_NOTUSED.dat
  export ${PRG}_O3=${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_ULAE.dat
  export ${PRG}_O4=${DFILT}/${NJOB}_50_${IB}_${PRG}_REMAINTOPAY_FHNI.dat
  EXECPRG
...
EOF
  ...
  # Copie fichiers
  #------------------------------------------------------------------------------
  LIBEL="CSF CALCULATION touch ${EST_GTSII_CASHFLOW} "
  EXECKSH_MODE=P
  EXECKSH "touch ${DFILT}/${NJOB}_50_${IB}_ESTC1056A_CASHFLOW.dat "
  EXECKSH "touch ${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_ULAE.dat"
  EXECKSH "touch ${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_FHNI.dat"
  
fi

if  [ ! -s ${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_FHNI.dat ]
then
  NSTEP=${NJOB}_55B
  # Copie fichiers
  #------------------------------------------------------------------------------
  LIBEL="touch REMAINTOPAY_FHNI "
  EXECKSH_MODE=P
  EXECKSH "touch ${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_FHNI.dat"
fi
...
NSTEP=${NJOB}_56
#-----------------------------------------------------------------------------
# SORT of ESTC1056A_REMAINTOPAY_FHNI
#-----------------------------------------------------------------------------
LIBEL="SORT of ESTC1056A_REMAINTOPAY_FHNI BOOKED - ASSUME"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_FHNI.dat 4000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_ESTC1056A_REMAINTOPAY_FHNI.dat"
...
NSTEP=${NJOB}_57
#-----------------------------------------------------------------------------
# SORT of ESTC1056A_REMAINTOPAY_FHNI - RETRO
#-----------------------------------------------------------------------------
LIBEL="SORT of ESTC1056A_REMAINTOPAY_FHNI BOOKED - RETRO"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_FHNI.dat 4000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_ESTC1056A_REMAINTOPAY_FHNI.dat"
...
EOF
  export ${PRG}_PRM=${FPRM}
  export ${PRG}_HOST_PRDSIT=${HOST_PRDSIT}
  export ${PRG}_I1=${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_ULAE.dat
  ...
  # Copie fichiers
  #------------------------------------------------------------------------------
  LIBEL="CSF CALCULATION touch ${EST_GTSII_REMAINTOPAY_ULAEINF}  "
  EXECKSH_MODE=P
...
then
 ...
 NSTEP=${NJOB}_65T
  #-----------------------------------------------------------------------------
  LIBEL="ICR CALCULATION Calcul du CashFlow (Transition)"
  PRG=ESTC1056A
  FPRM=`CFTMP`
  INPUT_TEXT ${FPRM} << EOF
TRIM_NF ${TRIM_NF}
...
EOF
  ...
  export ${PRG}_O2=${DFILT}/${NJOB}_65_${IB}_${PRG}_FSEGPATTERN_ICR_NOTUSED.dat
  export ${PRG}_O3=${DFILT}/${NJOB}_65_${IB}_${PRG}_GTSII_REMAINTOPAY_ULAEICR.dat
  export ${PRG}_O4=${DFILT}/${NJOB}_65_${IB}_${PRG}_REMAINTOPAY_FHNI.dat
  EXECPRG
...
EOF
  ...
  #------------------------------------------------------------------------------
  LIBEL="ICR CALCULATION touch ${DFILT}/${NJOB}_65_${IB}_${PRG}_GTSII_ICR.dat"
  EXECKSH_MODE=P
  EXECKSH "touch ${ESF_GTSII_ICR}"
  EXECKSH "touch ${DFILT}/${NJOB}_65_${IB}_ESTC1056A_GTSII_REMAINTOPAY_ULAEICR.dat"
  EXECKSH "touch ${DFILT}/${NJOB}_65_${IB}_ESTC1056A_REMAINTOPAY_FHNI.dat"
fi
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_65B_${IB}_ESTC2059_GTSII_NOTBOOKED_FWH.dat 1000 1"
...
NSTEP=${NJOB}_65C
#-----------------------------------------------------------------------------
# SORT of ESTC1056A_CASHFLOW
#-----------------------------------------------------------------------------
LIBEL="SORT of ESTC1056A_CASHFLOW"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_50_${IB}_ESTC1056A_CASHFLOW.dat 4000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_ESTC1056A_CASHFLOW.dat"
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS SSD_CF            1:1 -  1:EN,
        ESB_CF            2:1 -  2:EN,
        BALSHEY_NF        3:1 -  3:,
...
NSTEP=${NJOB}_65D
#-----------------------------------------------------------------------------
# SORT of ESTC1056A_GTSII_ICR
#-----------------------------------------------------------------------------
LIBEL="SORT of ESTC1056A_GTSII_ICR"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${ESF_GTSII_ICR} 4000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_ESTC1056A_GTSII_ICR.dat"
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS SSD_CF            1:1 -  1:EN,
        ESB_CF            2:1 -  2:EN,
        BALSHEY_NF        3:1 -  3:,
...
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_50_${IB}_ESTC1056A_CASHFLOW.dat 4000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_ESTC1056A_CASHFLOW_RETRO.dat"
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS SSD_CF            1:1 -  1:EN,
        ESB_CF            2:1 -  2:EN,
        BALSHEY_NF        3:1 -  3:,
...
SORT_CMD=`CFTMP`
SORT_I="${ESF_GTSII_ICR} 4000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_ESTC1056A_GTSII_ICR_RETRO.dat"
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS SSD_CF            1:1 -  1:EN,
        ESB_CF            2:1 -  2:EN,
        BALSHEY_NF        3:1 -  3:,
...
export ${PRG}_I2=${DFILT}/${NJOB}_65C_${IB}_SORT_ESTC1056A_CASHFLOW.dat
export ${PRG}_I3="${DFILT}/${NJOB}_65D_${IB}_SORT_ESTC1056A_GTSII_ICR.dat"
export ${PRG}_I4=${DFILT}/${NJOB}_56_${IB}_SORT_ESTC1056A_REMAINTOPAY_FHNI.dat
...
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1="${DFILT}/${NJOB}_65BB_${IB}_SORT_GTSII_NOTBOOKED_FWH.dat"
export ${PRG}_I2=${DFILT}/${NJOB}_65E_${IB}_SORT_ESTC1056A_CASHFLOW_RETRO.dat
export ${PRG}_I3="${DFILT}/${NJOB}_65F_${IB}_SORT_ESTC1056A_GTSII_ICR_RETRO.dat"
export ${PRG}_I4=${DFILT}/${NJOB}_57_${IB}_SORT_ESTC1056A_REMAINTOPAY_FHNI.dat
...
/CONDITION Bad_Dept TYP_CT="R" AND PATCAT1_CT="CSF" AND (( ACMTRS_NT = "101" OR ACMTRS_NT = "105" OR ACMTRS_NT = "201" OR ACMTRS_NT = "205" OR 
					...
					OR ( ACMTRS_NT = "401" AND PATTYP_CT="FHNI" ) )
/OUTFILE ${SORT_O}
/INCLUDE Bad_Dept
exit
EOF
...
#[31]
if [ ! -s "${DFILT}/${NJOB}_75_${IB}_ESTC1058A_GTSII_BADDEBT.dat" ]
then
NSTEP=${NJOB}_75B
#------------------------------------------------------------------------------
LIBEL="Create ouput file 1058A_GTSII_BADDEBT.dat"
...
SORT_I8="${DFILT}/${NJOB}_50_${IB}_ESTC1056A_REMAINTOPAY_ULAE.dat 2000 1"
