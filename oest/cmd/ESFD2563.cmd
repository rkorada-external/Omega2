...
if [[ ${BOUCLE} -gt 1 ]] ; then
  ECHO_LOG "compare si ${EST_DLDVGTR} ${EST_DLDVGTR}_SAV  sont identiques"
  ls -lrt   ${EST_DLDVGTR} ${EST_DLDVGTR}_SAV
  if [[ $(cmp  ${EST_DLDVGTR} ${EST_DLDVGTR}_SAV; echo $?) -eq 0 ]] ; then
    NSTEP=${NJOB}_36
