...
NSTEP=${NJOB}_15A
#------------------------------------------------------------------------------------
LIBEL="Excluse Life ${EST_FTECLEDA}"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
...
/joinkeys 
       TRNCOD_CF
/INFILE ${DFILT}/${NCHAIN}_ESFD4033_1_${NORME_CF}_05_${IB}_FTRSLNK_751.dat 2000 1 "~"       
/joinkeys 
       DETTRS_CF_F2
/OUTFILE ${SORT_O}
/REFORMAT 
...
NSTEP=${NJOB}_17C
# Join AND Extend ${ESF_FTECLEDA_OUT}_IFRS4_NOLIFE with CSM LC PROFITABLE
#-----------------------------------------------------------------------------
LIBEL="Join ${ESF_FTECLEDA_OUT}_IFRS4_NOLIFE.dat WITH ESFD3750_ESFD3770_PROFIT_CSM_LC"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
...
NSTEP=${NJOB}_17D
# Join AND Extend ${ESF_FTECLEDA_OUT}_IFRS4_NOLIFE with RETRO NP CSM
#-----------------------------------------------------------------------------
LIBEL="Join ${ESF_FTECLEDA_OUT}_IFRS4_NOLIFE.dat WITH ESFD3750_ESFD3770_ with RETRO NP CSM"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
#SORT_I="${DFILT}/${NJOB}_16_${IB}_${EST_BASE}_IFRS4_NOLIFE_RSLNK_O.dat 2000 1"
SORT_I="${DFILT}/${NJOB}_16A_${IB}_${EST_BASE}_SORT_IFRS4_NOLIFE_RSLNK_O.dat 2000 1"
...
NSTEP=${NJOB}_19D
# Remove Grouping 751 1010 1020 AND CSM LC Prof from ${ESF_FTECLEDA_OUT}_IFRS4_NOLIFE
#-----------------------------------------------------------------------------
LIBEL=" UPDATE ${ESF_FTECLEDA_OUT}_IFRS4_NOLIFE WITH cancellables mouvements "
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_15A_${IB}_${EST_BASE}_SORT_IFRS4_NOLIFE.dat 2000 1"
...
NSTEP=${NJOB}_20
#------------------------------------------------------------------------------------
LIBEL="Apply transformation to ${EST_FTECLEDA}"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
#SORT_I="${DFILT}/${NJOB}_15_${IB}_${EST_BASE}_IFRS4_NOLIFE.dat 2000 1"
...
/JOINKEYS
        S_DETTRS_CF
/INFILE ${DFILT}/${NCHAIN}_ESFD4033_1_${NORME_CF}_10_${IB}_GAAPMAP_IFRS4.dat 2000 1 "~"
/JOINKEYS
        ORIDETTRS_CF
/OUTFILE ${SORT_O} overwrite
/REFORMAT
