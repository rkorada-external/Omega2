...
#[005] 19/11/2014 R. Cassis  :spot:27747 - OM2C Add 39 columns for multicurrency and future life needs
#[006] 15/02/2016 -=Dch=-    :spot:30167 - Modification des calculs de commissions: Ajout du prg ESTC1012 et modification du prog et de l'appel de ESTC1018
#[029] 20/09/2019 NLD        :spira:67260 - Ajout input CURQUOT ESTC0623
#[030] 14/07/2020 KBAGWE       :spira:81022 - NDIC floarat file genration step:_190
#[031] 01/10/2020 MZM          :spira:88836 IFRS 17 - REQ 11.07 - Tax rate not applied when section >= 10 : Ajout du parametre CHAIN pour trie par No Section Numerique si CHAIN = ESFD2220
#===========================================================
#set -x
...
then
	PRS=710
	EST_FT=${EST_FT_IFRS}
	EST_FCTREST1=${EST_FCTREST1_IFRS}
	...
	then
		EST_FT=${EST_FT_EBS}
		EST_FCTREST1=${EST_FCTREST1_EBS}
		EST_DLDGTAA=${EST_DLDGTAA_EBS}
		EST_FLOARAT=${EST_FLOARAT_EBS}
		EST_FPRMLOA=${EST_FPRMLOA_EBS}
		EST_FSEGEST=${EST_FSEGEST_SOLVENCY}		
	else
		EST_FTFAMCHG=${EPO_FTFAMCHG}
		EST_FT=${EPO_FT_EBS}
		EST_FCTREST=${EPO_FCTREST}
		EST_FCTREST1=${EPO_FCTREST1_EBS}
		EST_FLOARAT=${EPO_FLOARAT_EBS}
		EST_FPRMLOA=${EPO_FPRMLOA_EBS}
		EST_DLCGTAA=${EPO_DLCGTAA}
		EST_DLGTAAPA=${EPO_DLGTAAPA}
		EST_DCGTAALOA=${EPO_DCGTAALOA}
		EST_DLGTAAFPRE=${EPO_DLGTAAFPRE}
		EST_DLCGTAAREC=${EPO_DLCGTAAREC}
		EST_DLGTAARPPE=${EPO_DLGTAARPPE}
		EST_DLGTAAPRE=${EPO_DLGTAAPRE}
		EST_DLGTAATFPNAE=${EPO_DLGTAATFPNAE}
		EST_DLCGTAAEPPE=${EPO_DLCGTAAEPPE}
		EST_FTFAC=${EPO_FTFAC}
    	EST_FCTRGRO=${EPO_FCTRGRO}
		EST_FCTRGRO1=${EPO_FCTRGRO1}
		EST_LABOCY1=${EPO_LABOCY1}
		EST_FSEGEST=${EPO_FSEGEST_SOLVENCY}	# pas dans ESPT
		if [ "${TYPEINV}" = "POS" ]
  		then
  		    EST_FSEGEST=${EPO_FSEGEST_SOLVENCYSO}       # pas dans ESPT 
  		    EST_FCTREST1=${EPO_FCTREST1SO}					#[004]
  		    EST_DLDGTAA=${EPO_DLDGTAA_EBSSO}				#[004]         
  		else
  		    EST_FSEGEST=${EPO_FSEGEST_SOLVENCYCO}       #[004]
  			 EST_FCTREST1=${EPO_FCTREST1CO}					#[004]
  			 EST_DLDGTAA=${EPO_DLDGTAA_EBSCO}				#[004]
  		fi		
  		EST_FCURQUOT=${EPO_FCURQUOT}
   	EST_IADPERIFR=${EPO_IADPERIFR}
   	EST_IADPERICASE=${EPO_IADPERICASE}
  		EST_DLCUMGTAAS=${EPO_DLCUMGTAAS}
  		EST_FTTR_PRM=${EPO_FTTR_PRM}
  		EST_CTRULT02=${EPO_CTRULT02}
  		EST_IADPERIFCT=${EPO_IADPERIFCT}
  		EST_IADPERIFCI=${EPO_IADPERIFCI}
...
ECHO_LOG "#===> EST_FCTREST...............= ${EST_FCTREST}"
...
#-----------------------------------------------------------------------------
RMFIL "
 `dirname ${EST_DLDGTAA}`/${NCHAIN}_DLDGTAA*.dat
...
NSTEP=${NJOB}_25
# CTREST temporary file deletion
#-----------------------------------------------------------------------------
LIBEL="CTREST temporary file deletion ..."
RMFIL ${DFILT}/${NJOB}_10_${IB}_SORT_CTREST_O.dat
...
then
	...
	SORT_WDIR=${SORTWORK}
	SORT_CMD=`CFTMP`
	SORT_I="${EPO_IADPERICASE} 1000 1"
	SORT_O=${DFILT}/${NCHAIN}_ESID2011_80_${IB}_ESTC1005_IADPERICASE_O2.dat
	INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS CTR_NF             3:1 -  3:,
        END_NT             4:1 -  4:,
        SEC_NF             5:1 -  5:,
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NCHAIN}_ESID2011_80_${IB}_ESTC1005_IADPERICASE_O2.dat
...
RMFIL ${DFILT}/${NJOB}_20_${IB}_ESTC1022_CTRESTCLM_O3.dat
RMFIL ${DFILT}/${NJOB}_50_${IB}_ESTC0602_GTCUMUL_O.dat
...
NSTEP=${NJOB}_75
# PERICASESEG temporary file deletion
#-----------------------------------------------------------------------------
LIBEL="PERICASESEG temporary file deletion ..."
RMFIL ${DFILT}/${NJOB}_60_${IB}_ESTC0623_PERICASESEG_O2.dat

NSTEP=${NJOB}_80
#Working file sort by Segment/UW Year/Currency/CTR/END/SEC/UW
#-----------------------------------------------------------------------------
LIBEL="Working file sort in progress..."
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
...
NSTEP=${NJOB}_85
# PERICASEEST temporary file deletion
#-----------------------------------------------------------------------------
LIBEL="PERICASEEST temporary file deletion ..."
RMFIL ${DFILT}/${NJOB}_60_${IB}_ESTC0623_PERICASEEST_O1.dat


NSTEP=${NJOB}_90
#FSEGEST file sort by Segment/UW Year/Currency
#-----------------------------------------------------------------------------
LIBEL="FSEGEST file sort in progress..."
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I=${EST_FSEGEST}
...
/KEYS SEG_NF,
      UWY_NF
/CONDITION BOOK AMORAT_CT = "R" OR AMORAT_CT = "S"
/INCLUDE BOOK
exit
EOF
SORT
...
NSTEP=${NJOB}_110
#Calculation of losses by Segment/UW Year
#SEGTYP_CT ${SEGTYP_CT}
#-----------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------
LIBEL="Temporary files deletion ..."
RMFIL ${DFILT}/${NJOB}_100_${IB}_ESTC0624_SEGESTEST_O.dat
...
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NJOB}_80_${IB}_SORT_PERICASEEST_O.dat            # PHP vient du 2001 à mettre dans DFILI
export ${PRG}_I2=${DFILT}/${NJOB}_110_${IB}_ESTC0625_SEGESTEST_O.dat
...
# ------------------------------------
gzip -c ${DFILT}/${NJOB}_80_${IB}_SORT_PERICASEEST_O.dat     > ${DFILT}/SAUVEGARDE_${NCHAIN}_I1_ESTC0626_PERICASEEST_O_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_110_${IB}_ESTC0625_SEGESTEST_O.dat   > ${DFILT}/SAUVEGARDE_${NCHAIN}_I2_ESTC0626_SEGESTEST_O_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_70_${IB}_SORT_PERICASESEG_O.dat     > ${DFILT}/SAUVEGARDE_${NCHAIN}_I3_ESTC0626_PERICASESEG_O_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_120_${IB}_SORT_GTCUMUL_O.dat         > ${DFILT}/SAUVEGARDE_${NCHAIN}_I5_SORT_GTCUMUL_O_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_130_${IB}_ESTC0626_DLCTREST1_O1.dat  > ${DFILT}/SAUVEGARDE_${NCHAIN}_O1_ESTC0626_DLCTREST1_O1_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_130_${IB}_ESTC0626_DLGTAAIBNR_O2.dat > ${DFILT}/SAUVEGARDE_${NCHAIN}_O1_ESTC0626_DLGTAAIBNR_O2_${NORME}.gz
# ----------------------------------------
...
#SORT_WDIR=${SORTWORK}
#SORT_CMD=`CFTMP`
#SORT_I=${DFILT}/${NJOB}_80_${IB}_SORT_PERICASEEST_O.dat
#SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_PERICASEEST_O.dat 500 1"
#INPUT_TEXT ${SORT_CMD} <<EOF
#
#/FIELDS CTR_NF    1:1 - 1:,
#        END_NT    2:1 - 2:,
...
#-----------------------------------------------------------------------------
LIBEL="Temporary files deletion ..."
RMFIL ${DFILT}/${NJOB}_110_${IB}_ESTC0625_SEGESTEST_O.dat
RMFIL ${DFILT}/${NJOB}_120_${IB}_SORT_GTCUMUL_O.dat
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NCHAIN}_ESID2011_80_${IB}_ESTC1005_IADPERICASE_O2.dat 1000 1"
...
# PHP export ${PRG}_O1=${EST_DLGTAABCREC}  #[001]
...
# TRACES POUR l'ENVIRONNEMENT DE TEST
# ------------------------------------
gzip -c ${DFILT}/${NJOB}_170_${IB}_SORT_IADPERICASE_O2.dat            > ${DFILT}/SAUVEGARDE_${NCHAIN}_170_SORT_IADPERICASE_O2_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_150_${IB}_SORT_DLCUMGTAAIBNR_O.dat           > ${DFILT}/SAUVEGARDE_${NCHAIN}_150_ESTC1015_DLCUMGTAAIBNR_O_${NORME}.gz
gzip -c ${DFILT}/${NSTEP}_${IB}_${PRG}_DLGTAABCREC_O1.dat             > ${DFILT}/SAUVEGARDE_${NCHAIN}_O1_ESTC1015_DLGTAABCREC_O1_${NORME}.gz
gzip -c ${DFILT}/${NSTEP}_${IB}_${PRG}_FTTR_O2.dat                    > ${DFILT}/SAUVEGARDE_${NCHAIN}_O2_ESTC1015_FTTR_O2_${NORME}.gz
# ----------------------------------------
# FIN TRACES POUR l'ENVIRONNEMENT DE TEST
# ----------------------------------------
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NCHAIN}_ESID2011_80_${IB}_ESTC1005_IADPERICASE_O2.dat	# PHP mettre ici un fichier dans DFILI
...
/CONDITION POSTEPRM
    ( WFCOD_NT EQ "10000" or WFCOD_NT EQ "8000" ) and
...
#-----------------------------------------------------------------------------
LIBEL="Temporary files deletion ..."
RMFIL ${DFILT}/${NJOB}_180_${IB}_ESTC1015_FTTR_O2.dat
...
export ${PRG}_I4=${DFILT}/${NCHAIN}_ESID2011_80_${IB}_ESTC1005_IADPERICASE_O2.dat
...
# TRACES POUR l'ENVIRONNEMENT DE TEST
# ------------------------------------
gzip -c ${DFILT}/${NJOB}_210_${IB}_SORT_FTCUM_O.dat             > ${DFILT}/SAUVEGARDE_${NCHAIN}_210_I1_ESTC1017_FTCUM_O_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_190_${IB}_ESTC1016_FLOARAT_O2.dat      > ${DFILT}/SAUVEGARDE_${NCHAIN}_190_I1_ESTC1016_FLOARAT_O2_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_220_${IB}_ESTC1017_FPRMLOA_O1.dat      > ${DFILT}/SAUVEGARDE_${NCHAIN}_220_O1_ESTC1017_FPRMLOA_${NORME}.gz
# ----------------------------------------
# FIN TRACES POUR l'ENVIRONNEMENT DE TEST
# ----------------------------------------
...
#-----------------------------------------------------------------------------
LIBEL="Temporary files deletion ..."
RMFIL ${DFILT}/${NJOB}_210_${IB}_SORT_FTCUM_O.dat

NSTEP=${NJOB}_240
# PHP ce step ne devrait pas etre là, mais dans le ESID2011
# Begin sort
#-----------------------------------------------------------------------------
...
/FIELDS CTR_NF            1:1 -  1:,
		...
		COND_EPP 		  4:1 -  4:,
		COND_RPP 		  5:1 -  5:,
		AMT_EPP 		  6:1 -  6:EN 15/3,
		AMT_RPP 		  7:1 -  7:EN 15/3,
		COM_EPP 		  8:1 -  8:EN 15/3,
		COM_RPP 		  9:1 -  9:EN 15/3,
		CUR_CF 			 10:1 -  10:
...
# TRACES POUR l'ENVIRONNEMENT DE TEST
# ------------------------------------
gzip -c ${DFILT}/${NJOB}_180_${IB}_ESTC1015_DLGTAABCREC_O1.dat         > ${DFILT}/SAUVEGARDE_${NCHAIN}_I3_ESTC1018_DLGTAABCREC_O1_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_220_${IB}_ESTC1017_FPRMLOA_O1.dat             > ${DFILT}/SAUVEGARDE_${NCHAIN}_I5_ESTC1018_FPRMLOA_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_240_${IB}_SORT_DLGTACUMARPPE_O.dat            > ${DFILT}/SAUVEGARDE_${NCHAIN}_I7_ESTC1018_DLGTACUMARPPE_O_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_250_${IB}_ESTC1018_DLGTAALOA_O.dat            > ${DFILT}/SAUVEGARDE_${NCHAIN}_O1_ESTC1018_DLGTAALOA_O_${NORME}.gz
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_290_${IB}_ESTM1002_IADPERICASE_TERM_O.dat 1000 1"
SORT_I2="${DFILT}/${NCHAIN}_ESID2011_80_${IB}_ESTC1005_IADPERICASE_O2.dat 1000 1"
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NJOB}_300_${IB}_SORT_IADPERICASE_O.dat
...
## TRACES POUR l'ENVIRONNEMENT DE TEST
## ------------------------------------
gzip -c ${DFILT}/${NJOB}_300_${IB}_SORT_IADPERICASE_O.dat          > ${DFILT}/SAUVEGARDE_${NCHAIN}_I1_ESTC1019_IADPERICASE_O_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_280_${IB}_SORT_DLCUMGTAATOT_O.dat         > ${DFILT}/SAUVEGARDE_${NCHAIN}_I3_ESTC1019_DLCUMGTAATOT_O_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_20_${IB}_ESTC1022_CTRESTLOSPBPAP_O1.dat   > ${DFILT}/SAUVEGARDE_${NCHAIN}_I6_ESTC1019_ESTC1022_CTRESTLOSPBPAP_O1_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_310_${IB}_ESTC1019_DLGTAAPBPAPLOS_O1.dat  > ${DFILT}/SAUVEGARDE_${NCHAIN}_O1_ESTC1019_DLGTAAPBPAPLOS_O1_${NORME}.gz
gzip -c ${DFILT}/${NJOB}_310_${IB}_ESTC1019_DLCTREST3_O2.dat       > ${DFILT}/SAUVEGARDE_${NCHAIN}_O2_ESTC1019_DLCTREST3_O2_${NORME}.gz
# ----------------------------------------
# FIN TRACES POUR l'ENVIRONNEMENT DE TEST
# ----------------------------------------
...
#-----------------------------------------------------------------------------
LIBEL="Temporary files deletion ..."
RMFIL ${DFILT}/${NJOB}_20_${IB}_ESTC1022_CTRESTLOSPBPAP_O1.dat
RMFIL ${DFILT}/${NJOB}_280_${IB}_SORT_DLCUMGTAATOT_O.dat
RMFIL ${DFILT}/${NJOB}_300_${IB}_SORT_IADPERICASE_O.dat
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_310_${IB}_ESTC1019_DLGTAAPBPAPLOS_O1.dat 500 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_DLGTAAPBPAPLOS_O1.dat 500 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS	DEBUT           1:1 - 41:
/DERIVEDFIELD PLUS_16_CHAMPS "~~~~~~~~~~~~~~~"
/OUTFILE ${SORT_O}
...
SORT_I4=${DFILT}/${NJOB}_320_${IB}_SORT_DLGTAAPBPAPLOS_O1.dat
...
#-----------------------------------------------------------------------------
LIBEL="Temporary files deletion ..."
RMFIL ${DFILT}/${NJOB}_310_${IB}_ESTC1019_DLGTAAPBPAPLOS_O1.dat
RMFIL ${DFILT}/${NJOB}_270_${IB}_SORT_DLGTAATOTP_O.dat
