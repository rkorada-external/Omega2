...
SORT_O3="${DFILT}/${NSTEP}_${IB}_SORT_DLGTAFACPNAERPCC_O3.dat"
...
/KEYS CTR_NF, END_NT, SEC_NF, UWY_NF, UW_NT, ACY_NF, SCOENDMTH_NF_FORMATE, SCOSTRMTH_NF_FORMATE, OCCYEA_NF, CLM_NF
/DERIVEDFIELD SCOENDMTH_NF_FORMATE   SCOENDMTH_NF (99)
/DERIVEDFIELD SCOSTRMTH_NF_FORMATE   SCOSTRMTH_NF (99)
/DERIVEDFIELD sep "~"
/OUTFILE ${SORT_O}
/REFORMAT BEFORE_SCOSTRMTH_NF , SCOSTRMTH_NF_FORMATE ,sep,SCOENDMTH_NF_FORMATE,sep,AFTER_SCOENDMTH_NF
exit
EOF
SORT
...
gzip -c ${DFILT}/${NJOB}_70_${IB}_SORT_DLCUMGTAA_O.dat  > ${DFILT}/TEST_ESID2000_70_DLCUMGTAA.gz
...
/FIELDS 
	...
	ALL_F1 									1:1 - 218:,
	CTR_NF_F2    						1:1 - 1:,
	CEDSTRYEA_NF_F2  				2:1 - 2:,
	PER_DATDERCPA_D_F2     	3:1 - 3:
/JOINKEYS PER_CTR_NF,
          PER_UWY_NF 	 
...
export ${PRG}_I1=${DFILT}/${NJOB}_95_${IB}_ESTC1005_IADPERICASE_O2.dat #[021]
...
# ------------------------------------
gzip -c ${DFILT}/${NJOB}_90_${IB}_ESTC1005_IADPERICASE_O2.dat   > ${DFILT}/${NJOB}_90_I1_ESTC1005_IADPERICASE_O2.gz
gzip -c ${DFILT}/${NJOB}_80_${IB}_ESTC1005_DSUMGTAA_O1.dat      > ${DFILT}/${NJOB}_80_I2_ESTC1005_DSUMGTAA_O1.gz
gzip -c ${DFILT}/${NJOB}_80_${IB}_ESTC1005_IADPERIPRMD_O3.dat   > ${DFILT}/${NJOB}_80_I3_ESTC1005_IADPERIPRMD_O3.gz
gzip -c ${DFILT}/${NJOB}_20_${IB}_SORT_DLGTAFACPNAE_O1.dat      > ${DFILT}/${NJOB}_20_I6_SORT_DLGTAFACPNAE_O1.gz
gzip -c ${DFILT}/${NJOB}_150_${IB}_${PRG}_FTTR_O2.dat           > ${DFILT}/${NJOB}_150_O2_FTTR_O2.gz
gzip -c ${DFILT}/${NJOB}_150_${IB}_${PRG}_PNA_O5.dat            > ${DFILT}/${NJOB}_150_O5_PNA_O5.gz
## ----------------------------------------
...
# TRACES POUR l'ENVIRONNEMENT DE TEST
# [006]-------------------------------
gzip -c ${DFILT}/${NJOB}_185_${IB}_SORT_IADPERICASE_O.dat        > ${DFILT}/SAUVEGARDE_ESID2000_I1_SORT_IADPERICASE_O.gz
