...
#	14/12/2021      DaD     	100753      add step 05 Merge CASHFLOW and DUMMY_STD and ONE_STD
#===============================================================================================
#set -x
...
NSTEP=${NJOB}_05
LIBEL="MERGE EPO_GTSII_GLOBAL_CASHFLOW and ESF_GTSII_DUMMY_STD and ESF_GTSII_ONE_STD FILES ..."
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${EPO_GTSII_GLOBAL_CASHFLOW} 2000 1"
SORT_I2="${ESF_GTSII_DUMMY_STD} 2000 1"
SORT_I3="${ESF_GTSII_ONE_STD} 2000 1" 
SORT_O="${DFILT}/${NSTEP}_${IB}_MERGE_CASHFLOW_INI_DUMMY_STD_ONE_STD.dat"
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_05_${IB}_MERGE_CASHFLOW_INI_DUMMY_STD_ONE_STD.dat 2000 1"
