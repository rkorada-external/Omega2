...
# nom du script SHELL:            ESTD3012.cmd
...
# description
#
# generation des fichiers retro GT CURGT STAGT ARCSTATGT pour les nouveaux contrats
#
#-----------------------------------------------------------------------------
# historiques des modifications :
#     <JJ/MM/AAAA> <Auteur >  <Description de la modification>
# [02] 07/07/2011   Florent    :spot:22328 ajout de 16 champs dans le GTA -> 
# [03] 13/07/2011 Roger Cassis :spot:22358 non pas pour la retro -> annule
#
#===============================================================================
#set -x
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILP}/${PCH}ESTD3010_ESTD3011_GTA_TRANSFP_EST.dat 1000 1"
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILP}/${PCH}ESTD3010_ESTD3011_CURGTA_TRANSFP_EST.dat 1000 1"
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILI}/${PCH}ESTD3010_ESTD3011_ARCSTATGTA_TRANSFP.dat 1000 1"
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILP}/${PCH}ESTD3010_ESTD3011_ARCSTATGTA_TRANSFP_EST.dat 1000 1"
