...
# nom du script SHELL           : ESFD3621.cmd
...
#[007] 05/07/2022 JBD			SPIRA 104778 Build new closing for I17S norm 
#[008] 14/11/2023 JYP/Florian	SPIRA 110485 : produce many outputs by ACMTRS
#===============================================================================
...
/CONDITION CSF_IFRS ((NORME_CF = "SII" OR NORME_CF = "IFRSI" OR NORME_CF = "GIM" OR NORME_CF = "EV" OR NORME_CF = "ALLNO") AND PATCAT1_CT="CSF" AND PATTYP_CT="INF")
		OR (PATCAT1_CT!="CSF" AND PATCAT1_CT!="BDT" AND PATCAT1_CT!="RAD")
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1="${DFILT}/${NJOB}_05_${IB}_SORT_GTSII_GLOBAL_CASHFLOW.dat"
export ${PRG}_I2=${ESF_FSEGPATTERNDSCf17}
export ${PRG}_I3=${EPO_FCURSII}
export ${PRG}_I4=${ESF_TRERETFACCTR}
export ${PRG}_I5=${ESF_ILL_BUCKET}
export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_ESTC2066_GTSII_CSF.dat
EXECPRG
...
NSTEP=${NJOB}_07B
#------------------------------------------------------------------------------
LIBEL="touch ${DFILT}/${NJOB}_07_${IB}_ESTC2066_GTSII_CSF.dat"
EXECKSH "touch ${DFILT}/${NJOB}_07_${IB}_ESTC2066_GTSII_CSF.dat"
...
EXECKSH "cp ${DFILT}/${NJOB}_07_${IB}_ESTC2066_GTSII_CSF.dat ${ESF_GTSII_ESCOMPTE}"
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1=${DFILT}/${NJOB}_09_${IB}_SORT_GTSII_GLOBAL_CASHFLOW.dat
export ${PRG}_I2="${DFILT}/${NJOB}_001_${IB}_SORT_FPRSMAP.dat"
export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_ESTC2065_GTSII_CSF.dat
...
EOF
export ${PRG}_PRM=${FPRM}
export ${PRG}_I1="${DFILT}/${NJOB}_09A_${IB}_ESTC2065_GTSII_CSF.dat"
export ${PRG}_I2="${DFILT}/${NJOB}_09B_${IB}_SORT_FSEGPATTERN_DSC.dat"
export ${PRG}_I3=${EPO_FCURSII}
export ${PRG}_I4=${ESF_TRERETFACCTR}
export ${PRG}_I5=${ESF_ILL_BUCKET}
export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_ESTC2066_GTSII_CSF.dat
...
NSTEP=${NJOB}_10B
#------------------------------------------------------------------------------
LIBEL="touch ${DFILT}/${NJOB}_10_${IB}_ESTC2066_GTSII_CSF.dat"
EXECKSH "touch ${DFILT}/${NJOB}_10_${IB}_ESTC2066_GTSII_CSF.dat"
...
#------------------------------------------------------------------------------
LIBEL="CP ESTC2066_GTSII_CSF.dat ==> ESF_GTSII_ESCOMPTE"
EXECKSH "cp ${DFILT}/${NJOB}_10_${IB}_ESTC2066_GTSII_CSF.dat ${ESF_GTSII_ESCOMPTE}"
