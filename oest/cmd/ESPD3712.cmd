...
# nom du script SHELL           : ESPD3712.cmd
# revision                      : 
# date de creation              : 12/02/2026
# auteur                        : MZM
# references des specifications : US7847  
#-----------------------------------------------------------------------------
# description
#   Generated Files for Update TSECIFRS and TRETIFRS (for EBS INI  contracts 
#
# Input files
#       EPO_FTVENTNP                DFILP
