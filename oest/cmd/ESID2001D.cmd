...
gzip -c ${EST_DSUMGTAA}      > ${DFILT}/${NJOB}_80_I2_ESTC1005_DSUMGTAA_O1.gz
gzip -c ${EST_IADPERIPRMD_CONV}   > ${DFILT}/${NJOB}_80_I3_ESTC1005_IADPERIPRMD_O3.gz
