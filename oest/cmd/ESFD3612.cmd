...
#[022] 28ES1056/06/2018 JYP - PERSEE :  SPIRA 069426 : REQ 00.01 - this job manage cashflow calculation 
...
#[034] 12/03/2020 JYP SPIRA 79070: retro at inception 
#[035] 02/11/2020 M.NAJI SPIRA 91421  : optimisation, refonte de des job ESID3702A 
#[035] From ESID3702A] 02/04/2020 JYP SPIRA 92591: AE assumed , at inception
#[036] 03/01/2022 M.NAJI  SPIRA 101403 Optimisation du ESTC1051A
#[037] 18/02/2022 MZM FIX UAT : SPIRA 101403 MAJ Taille segment de tri 1000 1 ==> 2000 1 et  500 1 ==> 2000 1
#[038] 07/07/2022 JYP fix PROD: SPIRA 105397 add a specific sort for transition file
#[039} 01/11/2022 M.NAJI : SPIRA 104469 Ajout du step 258 pour filtrer FWHGTR avec FPLATXCUMALL
#[040] 08/09/2023 MZM : SPIRA 109430 IO DUM : MERGE CASHFLOWS PREVIOUS DUMMY AND NEW DUMMY GENERATE FROM ESFD3610 IDF_CT =  I17G/L/P/S_CSF_MRG_INI
#[041] 17/01/2024 JYP : SPIRA 110485 :  exclude when PARM1 is empty
#[042] 20/03/2024 DAD : spira 110913 : add CTRNAT_CT, UWY_NF, LOBN2_NF for R03-00 - ULAE Ratio Extraction 
#[043] 18/04/2025 MZM : SPIRA 112870 BBNI- Undiscounted future transactions mapping 
#[044] 04/06/2025 JYP : SPIRA 113073 : écart claims LKI, bugfix grp 303
#[045] 13/10/2025 MZM : US 5637 EBS INI future transactions mapping
#===============================================================================
...
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_FBOPRSLNK_ACCEPT.dat 2000 1"
SORT_O2="${DFILT}/${NSTEP}_${IB}_SORT_FBOPRSLNK_RETRO.dat 2000 1"
...
SORT_O="${DFILT}/${NSTEP}_${IB}_FTRSLNK_751.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS  PRS_CF    1:1 -  1:
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_05_${IB}_SORT_FBOPRSLNK_ACCEPT.dat  2000 1 "
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_05_${IB}_SORT_FBOPRSLNK_RETRO.dat  2000 1 "
...
/CONDITION COND_ORIGINE ( ( "AEJ" CT TRNCOD2_CF ) OR ( "$IDF_CT" = "I17G_CSF_MRG_INI"  OR   "$IDF_CT" = "I17S_CSF_MRG_INI"  OR   "$IDF_CT" = "I17P_CSF_MRG_INI" OR  "$IDF_CT" = "I17L_CSF_MRG_INI"  ) )
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_15_${IB}_FTRSLNK_751.dat 2000 1 "
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_10_${IB}_SORT_FBOPRSLNK_FPRSMAP.dat 2000 1 "
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${EST_IADPERICASE_CTRGRO} 2000 1"
...
#[036]
NSTEP=${NJOB}_85
# CSF AGREGATES 1051 ACCEPT Add cols data to GT format ACMTRS/LOB/CUR + CONVERSION
#-----------------------------------------------------------------------------
PRG=ESTC1051A
export LIBEL="CSF AGREGATES 1051 ACCEPT Add cols data to GT format ACMTRS/LOB/CUR + CONVERSION"
export ACCRET_CT=A
export BALSHTYEA_NF=${BALSHTYEA_NF}
export PRS_CF=751 
export TMP_PERICASE=${DFILT}/${NJOB}_75_${IB}_SORT_IADPERICASE_O.dat
export TMP_GT=${DFILT}/${NJOB}_80_${IB}_SORT_DLSIIGTAAR_O.dat
export TMP_GTCUM_ACCRET=${DFILT}/${NSTEP}_${IB}_${PRG}_GTESTCUMUL1_ACCRET.dat
export TMP_GTCUM_ACCRET_ANO=${DFILT}/${NSTEP}_${IB}_${PRG}_ANO.dat
. $DCMD/ES1051C1.cmd
...
LIBEL="PREPARATION : Sort ESF_IADVPERICASE_P for CTRGRO  "
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${ESF_IADVPERICASE_P} 2000 1"                                   
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_IADVPERICASE_${IDF_CT}_$$.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS SSD_CF      1:1 - 1:EN,
        CTR_NF      3:1 -  3:,
        END_NT      4:1 -  4:,
...
LIBEL="PARM_IS_TRN=$PARM_IS_TRN : ESF_IADVPERICASE_P for CTRGRO  "
EXECKSH_MODE=P
EXECKSH "cp ${ESF_IADVPERICASE_P} ${DFILT}/${NSTEP}_${IB}_SORT_IADVPERICASE_${IDF_CT}_$$.dat "
...
PRG=ESTM1004
export ${PRG}_I1=${DFILT}/${NJOB}_86_${IB}_SORT_IADVPERICASE_${IDF_CT}_$$.dat
...
#[036]
NSTEP=${NJOB}_100
# CSF AGREGATES 1051 RETROCESSION Add cols data to GT format ACMTRS/LOB/CUR + CONVERSION
#-----------------------------------------------------------------------------
PRG=ESTC1051A
export LIBEL="CSF AGREGATES 1051 RETROCESSION Add cols data to GT format ACMTRS/LOB/CUR + CONVERSION"
export ACCRET_CT=R
export BALSHTYEA_NF=${BALSHTYEA_NF}
export PRS_CF=751 
export TMP_PERICASE=${DFILT}/${NJOB}_90_${IB}_SORT_IRDPERICASE_O.dat
export TMP_GT=${DFILT}/${NJOB}_95_${IB}_SORT_GTESTCUMUL1_ACCRET_O.dat
export TMP_GTCUM_ACCRET=${DFILT}/${NSTEP}_${IB}_${PRG}_GTESTCUMUL1_ACCRET.dat
export TMP_GTCUM_ACCRET_ANO=${DFILT}/${NSTEP}_${IB}_${PRG}_ANO.dat
. $DCMD/ES1051C1.cmd 
...
/CONDITION  RETACC ( LOB_CF != "30" AND LOB_CF != "31" AND LOB_CF != "") AND (TYP_CT = "R" AND CTR_NF != '' AND CTR2_NF != ' ') AND DEPOT='NON' AND ACMTRS_NT='303' 
...
/FIELDS
		...
		FWHGTR_RETCTR_NF        24:1 - 24:,
        FWHGTR_RETSEC_NF        26:1 - 26:,
        FWHGTR_RTY_NF           27:1 - 27:,
		FWHGTR_PLC_NT           36:1 - 36:,
        FWHGTR_ALL           	1:1 - 40:,

		FPLATXCUMALL0_RETCTR_NF 			1:1 - 1:,
        FPLATXCUMALL0_RETSEC_NF 			2:1 - 2:,
        FPLATXCUMALL0_RETRTY_NF 			3:1 - 3:,
        FPLATXCUMALL0_PLC_NT    			4:1 - 4:
...
/joinkeys
        ...
        FWHGTR_RTY_NF    ,
		FWHGTR_PLC_NT           
/INFILE ${DFILT}/${NJOB}_40_${IB}_FPLATXCUMALL.dat   2000 1  "~"
/joinkeys
  		FPLATXCUMALL0_RETCTR_NF ,
        FPLATXCUMALL0_RETSEC_NF ,
        FPLATXCUMALL0_RETRTY_NF ,
        FPLATXCUMALL0_PLC_NT    
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_258_${IB}_SORT_FWHGTR_O.dat  2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_FWHGTR_O.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS SSD_CF            1:1 -  1:EN,
        ESB_CF            2:1 -  2:EN,
...
if [ "${CONTEXT_CT}" = "INI" ] || [ "${PATCAT_CT}" = "NDC" ]  || [ "${IDF_CT}" = "EBS_ESPD3610_BBNI" ]  || [ "${IDF_CT}" = "EBS_ESPD3610_INI" ]   # Closing at Inception or EBS_BBNI or EBS_INI
then
NSTEP=${NJOB}_270
PRG=ESTC8805
LIBEL="AT INCEPTION OR EBS_BBNI OR EBS_INI: touch retro files for context I17G INI "
EXECKSH_MODE=P
...
NSTEP=${NJOB}_271a
#------------------------------------------------------------------------------
LIBEL="exclude when PARM1 is empty "
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_270a_${IB}_ESTC8805_FWHGTARR.dat 2000 1"
SORT_O=${DFILT}/${NSTEP}_${IB}_ESTC8805_FWHGTARR.dat
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS PRSMAP_PARM1     63:1 - 63:		
/CONDITION COND_PARM1 PRSMAP_PARM1 != ""
/OUTFILE ${SORT_O}
/INCLUDE COND_PARM1
exit
EOF
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_271a_${IB}_ESTC8805_FWHGTARR.dat 2000 1"
...
#[036]
NSTEP=${NJOB}_272
# FWH Retro : FWH GTARR : Fill ACMTRS, currencies, segmentaion for Retro
#-----------------------------------------------------------------------------
PRG=ESTC1051A
export LIBEL="FWH Retro : FWH GTARR : Fill ACMTRS, currencies, segmentaion for Retro"
export ACCRET_CT=A
export BALSHTYEA_NF=${BALSHTYEA_NF}
export PRS_CF=751 
export TMP_PERICASE=${DFILT}/${NJOB}_75_${IB}_SORT_IADPERICASE_O.dat
export TMP_GT=${DFILT}/${NJOB}_271_${IB}_SORT_FWHGTARR.dat
export TMP_GTCUM_ACCRET=${DFILT}/${NSTEP}_${IB}_${PRG}_FWHGTARR.dat
export TMP_GTCUM_ACCRET_ANO=${DFILT}/${NSTEP}_${IB}_${PRG}_ANO.dat
. $DCMD/ES1051C1.cmd 
...
export BALSHTYEA_NF=${BALSHTYEA_NF}
export PRS_CF=751 
export TMP_PERICASE=${DFILT}/${NJOB}_90_${IB}_SORT_IRDPERICASE_O.dat # Perimetre Accept ou retro selon valeur ACCRET
export TMP_GT=${DFILT}/${NJOB}_273_${IB}_SORT_FWHGTARR.dat
export TMP_GTCUM_ACCRET=${DFILT}/${NSTEP}_${IB}_${PRG}_FWHGTARR.dat # Sortie Accept ou retro selon valeur ACCRET
export TMP_GTCUM_ACCRET_ANO=${DFILT}/${NSTEP}_${IB}_${PRG}_ANO.dat
. $DCMD/ES1051C1.cmd 
...
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_100_${IB}_ESTC1051A_GTESTCUMUL1_ACCRET.dat 2000 1"
SORT_I2="${DFILT}/${NJOB}_274_${IB}_ESTC1051A_FWHGTARR.dat 2000 1"  
SORT_O="${DFILT}/${NSTEP}_${IB}_GTESTCUMUL1_ACCRET.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS SSD_CF            1:1 -  1:EN,
        ESB_CF            2:1 -  2:EN,
        BALSHEY_NF        3:1 -  3:,
...
/CONDITION COND_TRNCOD ((( ACMTRS_NT = "101" OR ACMTRS_NT = "105" OR ACMTRS_NT = "201" OR ACMTRS_NT = "205" OR
                         ...
                         OR  
                         ( "$IDF_CT" = "I17G_CSF_MRG_INI"  OR   "$IDF_CT" = "I17S_CSF_MRG_INI"  OR   "$IDF_CT" = "I17P_CSF_MRG_INI" OR  "$IDF_CT" = "I17L_CSF_MRG_INI" ) )
/SUMMARIZE  TOTAL AMT_M, TOTAL RETAMT_M, TOTAL RETINTAMT_M, TOTAL ACMAMT_M
/DERIVEDFIELD AMT_MC AMT_M COMPRESS
/DERIVEDFIELD RETAMT_MC RETAMT_M COMPRESS
/DERIVEDFIELD RETINTAMT_MC RETINTAMT_M COMPRESS
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_400_${IB}_GTESTCUMUL1_ACCRET.dat 2000 1"
SORT_O="${EST_DLCUMGTAAR_IBNR_FUTCLAIMS} 2000 1"
SORT_O2="${DFILT}/${NSTEP}_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat 2000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS SSD_CF            1:1 -  1:EN,
        ESB_CF            2:1 -  2:EN,
        CTR_NF            8:1 -  8:,
...
NSTEP=${NJOB}_530
#-----------------------------------------------------------------------------
LIBEL="JOIN UNPAIRED GTESTCUMUL1_ACCRET_ULAE and ESF_FTUWSEC"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_500_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS F1_CTR_NF            8:1 -  8:,
        F1_END_NT            9:1 -  9:,
        F1_SEC_NF           10:1 - 10:,
        F1_UWY_NF           11:1 - 11:,
        F1_UW_NT            12:1 - 12:,
...
/OUTFILE ${SORT_O} overwrite
/REFORMAT
       leftside:F1_COL_1_52, rightside:F2_LOBN2
exit
EOF
SORT
...
NSTEP=${NJOB}_530_1
#-----------------------------------------------------------------------------
LIBEL="JOIN UNPAIRED GTESTCUMUL1_ACCRET_ULAE and FULAERAT"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_530_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS 
       F1_SSD_CF            1:1 -  1:,
...
/JOINKEYS
	...
	F1_UWY_NF,
       F1_LOBN2_NF       
/INFILE ${DFILT}/${NJOB}_520_${IB}_FULAERAT.dat 2000 1  "~"
/JOINKEYS 
       F2_SSD_CF,
       F2_ESB_CF,
       F2_CTRNAT_CT,
...
/OUTFILE ${SORT_O} overwrite
/REFORMAT
       leftside:F1_COL_1_53, rightside:F2_UWY_NF
exit
EOF
SORT
...
NSTEP=${NJOB}_530_2
#-----------------------------------------------------------------------------
LIBEL="ADD DEFAULT UWY_NF of FULAERAT for GTESTCUMUL1_ACCRET_ULAE"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_530_1_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS 
       SSD_CF            1:1 -  1:EN,
...
NSTEP=${NJOB}_540
#-----------------------------------------------------------------------------
LIBEL="SORT GTESTCUMUL1_ACCRET_ULAE by SSD_CF, ESB_CF, CTRNAT_CT, UWY_NF_2, LOBN2_NF"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_530_2_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS 
       SSD_CF            1:1 -  1:EN,
...
PRG=ESTC1070A
export ${PRG}_I1=${DFILT}/${NJOB}_540_${IB}_GTESTCUMUL1_ACCRET_ULAE.dat # Perimetre Accept ou retro selon valeur ACCRET
...
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_400_${IB}_GTESTCUMUL1_ACCRET.dat 2000 1"
SORT_I2="${DFILT}/${NJOB}_550_${IB}_ESTC1070A_GTESTCUMUL1_ACCRET_ULAE.dat 2000 1"
