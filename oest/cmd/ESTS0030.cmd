...
# nom du script SHELL           : ESTS0030.cmd
# revision                      : $Revision:   1.0  $
# date de creation              : 13\08\2021
# auteur                        : AGD
#-----------------------------------------------------------------------------
# description : Sort CSM engine ASSUMED Pericase file by CSUOE
#-----------------------------------------------------------------------------
#=============================================================================
...
#-----------------------------------------------------------------------------
NSTEP=${NJOB}_$1
LIBEL="Sort CSM engine ASSUMED Pericase file by CSUOE"
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
