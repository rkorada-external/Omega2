...
#[07] 17/04/2019 M.NAJI     :spira:77319 remove set GET_FILES and use EPO_DLEIFTECLEDSIIEI_POOL appended by job TEFJ0012 in  ESPD2050 chain
#[08] 16/07/2019 R. CASSIS  :spira:68628 Normalisation du fichier EST_DLEIFTECLEDSIIEP pour POCE et POSE
##===============================================================================
#set -x
...
gzip -c ${EST_DLEIFTECLEDSIIEP} > ${DSAV}/${SVG}_${ENV_PREFIX}_ESPD3700_DLEIFTECLEDSIIEP.dat.gz
...
SORT_I="${DFILP}/${EPO_DLEIFTECLEDSIIEI_POOL} 2000 1"
...
NSTEP=${NJOB}_17
#---------------------------------------------------------------------------
LIBEL="Delete pool file of DLEIFTECLEDSII internal exchage"
EXECKSH "mv ${DFILP}/${EPO_DLEIFTECLEDSIIEI_POOL} ${DSAVE}/${SVG}_${EPO_DLEIFTECLEDSIIEI_POOL}"
EXECKSH "gzip ${DSAVE}/${SVG}_${EPO_DLEIFTECLEDSIIEI_POOL}"
