...
# nom du script SHELL           : ESFD4036.cmd
...
#                     - Copy ESFD4035.cmd (P&C) and adpated for Life
#
...
#
#===============================================================================
#[001] 04/01/2021 : SPIRA 107049: SBE : Copy from ESFD0435.cmd
#[002] 03/11/2022 : SPIRA 107049: SBE : IFRS17 LIFE - IFRS4 Reversal 
...
#[011] 22/07/2024 : SPIRA 111948: SBE : L&H- change IBNP cancellation granularity for retro
#===============================================================================
...
then
	...
	cp ${ESF_FTECLEDR_I17AELIFE} ${ESF_FTECLEDR_I17AELIFE_OUT}
	JOBEND
...
/KEYS   DETTRS_CF
/CONDITION VIE ( LOBACC_CF="30" OR LOBACC_CF="31" ) and (BALSHRMTH_NF >= ${ICLODAT_M0}) AND ( BALSHRMTH_NF <= ${ICLODAT_M} ) AND (BALSHEY_NF = ${ICLODAT_A} )
...
/OUTFILE ${SORT_O} overwrite
/REFORMAT
	leftside : S_HEAD,BALSHEY_NF_NEW,BALSHRMTH_NF_NEW,BALSHRDAY_NF_NEW, rightside : TARGDETTRS_CF, SEPARATEUR,leftside : S_MID1, CRE_NEW , leftside : S_MID2 , ORICOD_NEW, leftside : S_TAIL1,GAAPCOD_NEW,leftside : S_TAIL2,  rightside : MAPTYP_CT
exit
EOF
SORT
...
## Exclusion des Annulations du PRS 740 

##[009] Vider le champs _67 POur Les RECLASS
...
SORT_O="${DFILT}/${NSTEP}_${IB}_${EST_BASE}_ALL_SANS_PRS_740.dat 2000 1"
INPUT_TEXT $SORT_CMD <<EOF
/FIELDS
	SSD_CF            1:1 -  1:EN,
	ESB_CF            2:1 -  2:EN,
...
EXECKSH "cp ${DFILT}/${NJOB}_110_${IB}_${EST_BASE}_ALL_SANS_PRS_740.dat ${EST_DELTA}"
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_110_${IB}_${EST_BASE}_ALL_SANS_PRS_740.dat 2000 1"
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${ESF_FTECLEDR_I17AELIFE} 2000 1"
SORT_I2="${EST_OUT} 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_FTECLEDR_I17LIFE.dat 2000 1"
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS CTR_NF            8:1 -  8:,
        END_NT            9:1 -  9:EN,
        SEC_NF           10:1 - 10:EN,
...
cp ${DFILT}/${NSTEP}_${IB}_FTECLEDR_I17LIFE.dat ${ESF_FTECLEDR_I17AELIFE_OUT}
