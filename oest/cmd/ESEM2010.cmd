#!/bin/ksh
#=============================================================================
# nom de lapplication		: SEGMENTATION - BATCH - MONTHLY DAILY
# nom du script SHELL		: ESEM2010.cmd
...
# Launch the monthly and daily segmentation process
#-----------------------------------------------------------------------------
