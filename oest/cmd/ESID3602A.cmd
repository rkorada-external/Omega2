...
#                                 RISK MARGIN DESIGN
# nom du script SHELL           : ESID3602A.cmd
...
#[03] 29/06/2018 :spira 069426 : JYP PERSEE : nouvelle version copiée depuis ESID3602.cmd, mise à niveau architecture IFRS17  
#[04] 28/11/2018 :spira 73386 : Charles SOCIE : ACMTRSL3 for Risk Margin
#[05] 11/12/2019 RC  :spira:81496 Mise a jour de l'etablissement dans fichier DLDSIIRMGTAA a partir de PERICASE
#[06] 14/05/2020 R. Cassis :spira:87041 On ne force pas l'etablissement a partir du Pericase si poste retro
#[07] 09/12/2020 JYP : SPIRA 92421 : add ACMTRSL3_NT into DSC_CLM file
#[08] 02/03/2021 JYP : SPIRA 92514 : add ACMTRSL3_NT into DSC_CLM file
#[09] 07/04/2021 JYP : SPIRA 91531 : manage missing file FCTRGROLE
#[10] 13/01/2023 JYP : SPIRA 106938: risk-margin, diff ESB between SII and TL 
#===============================================================================
...
ECHO_LOG "#===> EST_FRISKMSII ............: ${EST_FRISKMSII}"
ECHO_LOG "#....................OUTPUT.................."
...
/KEYS   CTR_NF,
        ...
        UWY_NF,
        UW_NT
/CONDITION COND_ACMTRS (ACMTRS_NT="303" OR ACMTRS_NT="309" OR ACMTRS_NT="312" OR ACMTRS_NT="314" OR ACMTRS_NT="316"  OR ACMTRS3_NT="3201" OR ACMTRS3_NT="3010" ) 
/OUTFILE ${SORT_O}
/INCLUDE COND_ACMTRS
/REFORMAT 
        123_FIELDS
...
NSTEP=${NJOB}_22
#------------------------------------------------------------------------------
LIBEL="Get ESB from Pericase to GTSII_ESCOMPTE "
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_20_${IB}_SORT_GTSII_ESCOMPTE_CLM_O.dat 2000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTSII_ESCOMPTE_CLM_O.dat 2000 1 "
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS SSD_CF           1:1 -  1:,
        ESB_CF           2:1 -  2:,
...
NSTEP=${NJOB}_25
#------------------------------------------------------------------------------
LIBEL="Replace ESB from Pericase to GTSII_ESCOMPTE "
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_22_${IB}_SORT_GTSII_ESCOMPTE_CLM_O.dat 2000 1 "
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_GTSII_ESCOMPTE_CLM_O.dat 2000 1"
INPUT_TEXT ${SORT_CMD} << EOF
/FIELDS SSD_CF           1:1 -   1:,
        ESB_CF           2:1 -   2:,
        ...
        UW_NT           12:1 -  12:,
        all_cols1        3:1 -  123:,
        PER_ESB_CF      124:1 -  124:
/KEYS   CTR_NF,
        SEC_NF,
        UWY_NF,
        UW_NT		
/CONDITION blanc PER_ESB_CF = "" 
...
export ${PRG}_I2=${DFILT}/${NJOB}_25_${IB}_SORT_GTSII_ESCOMPTE_CLM_O.dat
...
wc -l ${DFILT}/${NJOB}_25_${IB}_SORT_GTSII_ESCOMPTE_CLM_O.dat
...
export ${PRG}_O2=${DFILT}/${NSTEP}_${IB}_${PRG}_GTSII_ALLOC.ano
EXECPRG
...
#[04] add derived field for ACMTRS3_NT and PRC3
NSTEP=${NJOB}_350
#-----------------------------------------------------------------------------
LIBEL="Tri / somme sur cles LOBSII, LE et norme du fichier GTSII_ESCOMPTE_CLM"
SORT_WDIR=${SORTWORK}
...
/DERIVEDFIELD ACMTRS3_NF  "3171"
/DERIVEDFIELD PRS_CFL3 "751~"
/OUTFILE ${SORT_O}
/REFORMAT SSD_CF,
          ESB_CF,
          CLODAT_D,
