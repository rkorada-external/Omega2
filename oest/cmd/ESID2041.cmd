...
#[047]  28/03/2022 SBE  spira:98141: IFRS17 FWH Bookings - Accruals
#[048]  06/10/2022 SBE  spira:106396: IFRS 17 FWH - Beginning accruals missing after complete account - Copy
#==============================================================================
#set -x
...
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_VLIFEST195_O${IT}.dat 1000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
/FIELDS CTR_NF 2:1 - 2:,
        END_NT 3:1 - 3:,
        SEC_NF 4:1 - 4:,
...
SORT_WDIR=${SORTWORK}
SORT_CMD=`CFTMP`
SORT_I="${DFILT}/${NJOB}_104_${IB}_SORT_VLIFEST195_O${IT}.dat 1000 1"
SORT_O="${DFILT}/${NSTEP}_${IB}_SORT_LIFEST_O${IT}.dat 1000 1"
INPUT_TEXT ${SORT_CMD} <<EOF
...
export ${PRG}_I3=${EST_SUBTRSESBPROP}
export ${PRG}_O1=${DFILT}/${NSTEP}_${IB}_SORT_DVGTAA_O${IT}.dat
export ${PRG}_O2=${DFILI}/${NSTEP}_${IB}_SORT_Ano${IT}.dat
EXECPRG
...
# Delete internal retro
#------------------------------------------------------------------------------
LIBEL="Delete FWH from DLVGTAA"
PRG=ESTC2161
export ${PRG}_I1=${DFILT}/${NJOB}_820_${IB}_SORT_DVGTAA_O${IT}.dat
export ${PRG}_I2=${EST_SUBTRS}
export ${PRG}_I3=${EST_SUBTRSBLOCKLIFEST}
export ${PRG}_O1=${EST_DLVGTAA}
export ${PRG}_O2=${DFILI}/${NSTEP}_${IB}_SORT_DLVGTAA_EXCLU${IT}.dat
EXECPRG
